			...
			if ($objDB->nf($tabla)==0){
				...
				if (isset($_REQUEST['antiguo'])==0){
					...
					if ($objDB->nf($tabla)>0){
						...
						if ($iDiasSeparacion>364 && $fila['core16peraca']>$_REQUEST['cara01idperaca']){
							if ($bDebug){$sDebug=$sDebug.fecha_microtiempo().' Se presenta mensaje de encuesta de antiguo, dias desde la caracterizacion: '.$iDiasSeparacion.'<br>';}
							$sMensaje=$ETI['msg_intro_antiguos'];
							$_REQUEST['antiguo']='';
							$bForzarNueva=true;
							$bVerIntro=true;
...
<?php
			...
			if ($bDebug){$sDebug=$sDebug.fecha_microtiempo().' Luego de mostrar bienvenida: <br>';}
...
if (isset($_REQUEST['cara44sexoversion'])==0){$_REQUEST['cara44sexoversion']=1;}
...
if (isset($_REQUEST['cara44bienversion'])==0){$_REQUEST['cara44bienversion']=2;}
...
if (isset($_REQUEST['cara44acadrazonreceso'])==0){$_REQUEST['cara44acadrazonreceso']=0;}
if (isset($_REQUEST['cara44acadrazonrecesodetalle'])==0){$_REQUEST['cara44acadrazonrecesodetalle']='';}
if (isset($_REQUEST['cara44campus_usocorreounad'])==0){$_REQUEST['cara44campus_usocorreounad']=0;}
if (isset($_REQUEST['cara44campus_usocorreounadno'])==0){$_REQUEST['cara44campus_usocorreounadno']=0;}
if (isset($_REQUEST['cara44campus_usocorreounadnodetalle'])==0){$_REQUEST['cara44campus_usocorreounadnodetalle']='';}
if (isset($_REQUEST['cara44campus_medioactivunad'])==0){$_REQUEST['cara44campus_medioactivunad']=0;}
...
if (($_REQUEST['paso']==1)||($_REQUEST['paso']==3)){
	...
	if ($objDB->nf($tabla)>0){
		...
		$sSQLcondi='cara44idcara='.$_REQUEST['cara01id'].'';
...
$bEntra=false;
if ($_REQUEST['cara44bienversion']==2){$bEntra=true;}
if ($bEntra){
...
<?php
$bEntra=false;
if ($_REQUEST['cara44bienversion']==0){$bEntra=true;}
if ($bEntra){
?>
<div class="GrupoCampos">
<label class="TituloGrupo" style="width:100%">
