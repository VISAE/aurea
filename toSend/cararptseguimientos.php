...
* Modulo 2336 cara33rptconsolacom.
...
// -- 2336 cara33rptconsolacom
require 'lib2336.php';
$xajax=new xajax();
$xajax->configure('javascript URI', $APP->rutacomun.'xajax/');
$xajax->register(XAJAX_FUNCTION,'f2336_Combocara33idcentro');
$xajax->register(XAJAX_FUNCTION,'f2336_Combocara33idprograma');
$xajax->register(XAJAX_FUNCTION,'sesion_abandona_V2');
$xajax->register(XAJAX_FUNCTION,'sesion_mantenerV4');
$xajax->register(XAJAX_FUNCTION,'f2336_HtmlTabla');
$xajax->processRequest();
if ($bPeticionXAJAX){
...
if (isset($_REQUEST['paginaf2336'])==0){$_REQUEST['paginaf2336']=1;}
if (isset($_REQUEST['lppf2336'])==0){$_REQUEST['lppf2336']=20;}
if (isset($_REQUEST['boculta2336'])==0){$_REQUEST['boculta2336']=0;}
...
$html_cara33idcentro=f2336_HTMLComboV2_cara33idcentro($objDB, $objCombos, $_REQUEST['cara33idcentro'], $_REQUEST['cara33idzona']);
...
$html_cara33idprograma=f2336_HTMLComboV2_cara33idprograma($objDB, $objCombos, $_REQUEST['cara33idprograma'], $_REQUEST['cara33idescuela']);
...
$objCombos->sAccion='paginarf2336()';
$html_blistar=$objCombos->html('', $objDB);
//$html_blistar=$objCombos->comboSistema(2336, 1, $objDB, 'paginarf2336()');
*/
//if ($seg_6==1){}
if (true){
...
if (false){
	...
	$aParametros[0]='';//$_REQUEST['p1_2336'];
	$aParametros[101]=$_REQUEST['paginaf2336'];
	$aParametros[102]=$_REQUEST['lppf2336'];
	...
	list($sTabla2336, $sDebugTabla)=f2336_TablaDetalleV2($aParametros, $objDB, $bDebug);
...
forma_cabeceraV3($xajax, $ETI['titulo_2336']);
echo $et_menu;
forma_mitad();
if (false){
?>
...
function imprimelista(){
	if (window.document.frmedita.seg_6.value==1){
		window.document.frmlista.consulta.value=window.document.frmedita.consulta_2336.value;
		window.document.frmlista.titulos.value=window.document.frmedita.titulos_2336.value;
...
function imprimeexcel(){
	...
	if (sError==''){
		asignarvariables();
		window.document.frmimpp.action='t2336.php';
...
function imprimep(){
	if (window.document.frmedita.seg_5.value==1){
		asignarvariables();
		window.document.frmimpp.action='p2336.php';
		window.document.frmimpp.submit();
<?php
...
function carga_combo_cara33idcentro(){
	...
	xajax_f2336_Combocara33idcentro(params);
	}
function carga_combo_cara33idprograma(){
	var params=new Array();
	params[0]=window.document.frmedita.cara33idescuela.value;
	xajax_f2336_Combocara33idprograma(params);
	}
function paginarf2336(){
	var params=new Array();
	params[99]=window.document.frmedita.debug.value;
	params[101]=window.document.frmedita.paginaf2336.value;
	params[102]=window.document.frmedita.lppf2336.value;
	...
	//document.getElementById('div_f2336detalle').innerHTML='<div class="GrupoCamposAyuda"><div class="MarquesinaMedia">Procesando datos, por favor espere.</div></div><input id="paginaf2333" name="paginaf2333" type="hidden" value="'+params[101]+'" /><input id="lppf2333" name="lppf2333" type="hidden" value="'+params[102]+'" />';
	xajax_f2336_HtmlTabla(params);
	}
...
<form id="frmimpp" name="frmimpp" method="post" action="p2336.php" target="_blank">
<input id="r" name="r" type="hidden" value="2336" />
...
<input id="boculta2336" name="boculta2336" type="hidden" value="<?php echo $_REQUEST['boculta2336']; ?>" />
<label class="Label30">
<input id="btexpande2336" name="btexpande2336" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(2336,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta2336']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge2336" name="btrecoge2336" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(2336,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta2336']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
</div>
<div id="div_p2336" style="display:<?php if ($_REQUEST['boculta2336']==0){echo 'block'; }else{echo 'none';} ?>;">
<?php
	}
...
if ($bconexpande){
	//Este es el cierre del div_p2336
?>
<div class="salto1px"></div>
</div>
<?php
...
<input id="titulo_2336" name="titulo_2336" type="hidden" value="<?php echo $ETI['titulo_2336']; ?>" />
<div class="titulos">
<div class="titulosD">
