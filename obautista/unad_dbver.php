...
while ($dbversion < $versionejecutable) {
	...
	if (($dbversion > 6000) && ($dbversion < 6101)) {
		if ($dbversion == 6093) {$sSQL = "CREATE TABLE saiu21directa (saiu21agno int NOT NULL, saiu21mes int NOT NULL, saiu21tiporadicado int NOT NULL, saiu21consec int NOT NULL, saiu21id int NOT NULL DEFAULT 0, saiu21origenagno int NOT NULL DEFAULT 0, saiu21origenmes int NOT NULL DEFAULT 0, saiu21origenid int NOT NULL DEFAULT 0, saiu21dia int NOT NULL DEFAULT 0, saiu21hora int NOT NULL DEFAULT 0, saiu21minuto int NOT NULL DEFAULT 0, saiu21estado int NOT NULL DEFAULT 0, saiu21idcorreo int NOT NULL DEFAULT 0, saiu21idsolicitante int NOT NULL DEFAULT 0, saiu21tipointeresado int NOT NULL DEFAULT 0, saiu21clasesolicitud int NOT NULL DEFAULT 0, saiu21tiposolicitud int NOT NULL DEFAULT 0, saiu21temasolicitud int NOT NULL DEFAULT 0, saiu21idzona int NOT NULL DEFAULT 0, saiu21idcentro int NOT NULL DEFAULT 0, saiu21codpais varchar(3) NULL, saiu21coddepto varchar(5) NULL, saiu21codciudad varchar(8) NULL, saiu21idescuela int NOT NULL DEFAULT 0, saiu21idprograma int NOT NULL DEFAULT 0, saiu21idperiodo int NOT NULL DEFAULT 0, saiu21numorigen varchar(20) NULL, saiu21idpqrs int NOT NULL DEFAULT 0, saiu21detalle Text NULL, saiu21horafin int NOT NULL DEFAULT 0, saiu21minutofin int NOT NULL DEFAULT 0, saiu21paramercadeo int NOT NULL DEFAULT 0, saiu21idresponsable int NOT NULL DEFAULT 0, saiu21tiemprespdias int NOT NULL DEFAULT 0, saiu21tiempresphoras int NOT NULL DEFAULT 0, saiu21tiemprespminutos int NOT NULL DEFAULT 0, saiu21solucion int NOT NULL DEFAULT 0, saiu21idcaso int NOT NULL DEFAULT 0)";}
		if ($dbversion == 6094) {$sSQL = "ALTER TABLE saiu21directa ADD PRIMARY KEY(saiu21id)";}
		if ($dbversion == 6095) {$sSQL = $objDB->sSQLCrearIndice('saiu21directa', 'saiu21directa_id', 'saiu21agno, saiu21mes, saiu21tiporadicado, saiu21consec', true);}
	}
