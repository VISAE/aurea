...
function guardaf2937() {
	...
	valores[2] = window.document.frmedita.visa37consec.value;
	valores[3] = window.document.frmedita.visa37id.value;
	valores[4] = window.document.frmedita.visa37nombre.value;
	valores[5] = window.document.frmedita.visa37activo.value;
	params = paramsf2937();
...
function eliminaf2937() {
	if (window.document.frmedita.visa37id.value != '') {
		ModalConfirmV2('&iquest;Est&aacute; seguro de eliminar el dato Subtipologias de convocatorias?', () => {
			params = paramsf2937();
			params[1] = window.document.frmedita.visa36id.value;
			params[2] = window.document.frmedita.visa37consec.value;
			params[3] = window.document.frmedita.visa37id.value;
			//params[7] = window.document.frmedita.p1_2937.value;
			params[99] = window.document.frmedita.debug.value;
...
function cargadatof2937(llave1) {
	window.document.frmedita.visa37consec.value = String(llave1);
	revisaf2937();
}
