...
function f2942_TablaDetalleV2($aParametros, $objDB, $bDebug = false)
{
	...
	*/
	$sSQLadd = ' AND visa42idtipo=' . $visa34id;
	...
	T6.gedo02nombre, TB.visa42tipodocumento, TB.visa42orden';
	...
	$res = $res . '<th><b>' . $ETI['visa42orden'] . '</b></th>';
	...
	while ($filadet = $objDB->sf($tabladetalle)) {
		...
		$et_visa42orden = $sPrefijo . $filadet['visa42orden'] . $sSufijo;
