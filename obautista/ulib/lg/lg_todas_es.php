...
$ETI['bt_ayuda'] = 'Ayuda en l&iacute;nea';
$ETI['bt_buscar'] = 'Buscar';
$ETI['bt_cambiar'] = 'Cambiar';
$ETI['bt_cancelar'] = 'Cancelar';
$ETI['bt_cerrar'] = 'Cerrar';
$ETI['bt_clonar'] = 'Clonar';
$ETI['bt_confirmar'] = 'Confirmar';
$ETI['bt_contabilizar'] = 'Contabilizar';
$ETI['bt_eliminar'] = 'Eliminar';
$ETI['bt_exportar'] = 'Exportar';
$ETI['bt_facturar'] = 'Facturar';
$ETI['bt_guardar'] = 'Guardar';
$ETI['bt_hoy'] = 'Hoy';
$ETI['bt_imprimir'] = 'Imprimir';
$ETI['bt_limpiar'] = 'Limpiar';
$ETI['bt_mini_cargararchivo'] = 'Cargar archivo';
$ETI['bt_mini_eliminararchivo'] = 'Eliminar archivo';
...
$ETI['confirma_eliminar'] = 'Esta seguro de eliminar el dato';
$ETI['definir'] = 'Por Definir';
$ETI['Definir'] = 'Por Definir';
$ETI['error_cadena_1'] = 'El campo ';
$ETI['error_cadena_2'] = ' es demasiado largo ';
$ETI['ing_campo'] = 'Ingrese el ';
$ETI['ing_campoa'] = 'Ingrese la ';
$ETI['ing_campoas'] = 'Ingrese las ';
$ETI['ing_campos'] = 'Ingrese los ';
$ETI['ing_contrasena'] = 'Ingrese su contrase&ntilde;a';
$ETI['ing_doc'] = 'Ingrese el documento';
$ETI['ing_vr'] = 'Ingrese el valor';
...
$ETI['label_atras'] = 'Regresar a la página anterior';
...
$ETI['lnk_ayudas'] = 'haga clic en este enlace';
...
$ETI['msg_abierto'] = 'Abierto';
$ETI['msg_acerca'] = 'Acerca de';
$ETI['msg_acercade'] = 'Acerca de...';
...
$ETI['msg_ayuda'] = 'Ayuda';
$ETI['msg_ayudas'] = 'Para consultar elementos de ayuda';
...
$ETI['msg_cargararchivo'] = 'Cargar archivo';
...
$ETI['msg_coma'] = 'Coma';
$ETI['msg_confirmaabrir'] = '&iquest;Est&aacute; seguro de abrir el registro?<br>esto le permite volver a modificar.';
$ETI['msg_confirmaeliminar'] = '&iquest;Est&aacute; seguro de eliminar el dato?';
$ETI['msg_confirmamodconsec'] = '&iquest;Est&aacute; seguro de cambiar el consecutivo?';
$ETI['msg_consultar_documento'] = 'Consultar documento';
...
$ETI['msg_error_notifica'] = 'Error al notificar';
...
$ETI['msg_hasta'] = 'Hasta';
$ETI['msg_imagenes'] = 'Imagenes';
$ETI['msg_ingles'] = 'Ingl&eacute;s';
$ETI['msg_itemabierto'] = 'El documento ha sido abierto';
$ETI['msg_itemcerrado'] = 'El documento ha sido cerrado';
$ETI['msg_itemeliminado'] = 'Item eliminado';
$ETI['msg_itemguardado'] = 'Item guardado';
$ETI['msg_itemmodificado'] = 'Item modificado';
...
$ETI['msg_listar'] = 'Listar';
$ETI['msg_manuales'] = 'Manuales';
$ETI['msg_menu_accesibilidad'] = 'Menú de accesibilidad';
$ETI['msg_miles'] = 'Miles';
$ETI['msg_millones'] = 'Millones';
$ETI['msg_multiple'] = 'M&uacute;ltiple';
$ETI['msg_na'] = 'No Aplica';
$ETI['msg_ninguna'] = 'Ninguna';
$ETI['msg_ninguno'] = 'Ninguno';
$ETI['msg_no_encontrado'] = 'No se ha encontrado el registro';
$ETI['msg_noasignado'] = 'No Asignado';
$ETI['msg_nocontabiliza'] = 'No contabiliza';
$ETI['msg_nombre'] = 'Nombre';
$ETI['msg_nopermiso'] = 'No tienes permiso para acceder a esta p&aacute;gina.';
$ETI['msg_nosesion'] = 'No hay una sesi&oacute;n activa.<br><a href="index.php" class="lnkresalte">Haga clic aqu&iacute; para iniciar sesi&oacute;n</a>';
$ETI['msg_opcional'] = ' (Opcional)';
$ETI['msg_orden'] = 'Orden';
...
$ETI['msg_servicio_no_disponible'] = 'Disculpe las molestias, en este momento nuestros servicios no est&aacute;n disponibles.<br>Por favor intente acceder m&aacute;s tarde.<br>Si el problema persiste, informe al administrador del sistema.';
$ETI['msg_sin_asignar'] = 'Sin asignar';
$ETI['msg_sin_fecha'] = 'Sin fecha';
$ETI['msg_sin_permiso_modulo'] = 'No cuenta con permiso para acceder a este m&oacute;dulo';
$ETI['msg_sindato'] = 'Sin Dato';
$ETI['msg_sindefinir'] = 'Sin Definir';
$ETI['msg_sinfecha'] = 'Sin fecha';
$ETI['msg_subir'] = 'Subir';
$ETI['msg_todas'] = 'Todas';
$ETI['msg_todos'] = 'Todos';
$ETI['msg_total'] = 'Total';
$ETI['msg_unico'] = '&Uacute;nico';
...
$ERR['2'] = 'No tiene permiso para Insertar';
$ERR['3'] = 'No tiene permiso para Modificar';
$ERR['4'] = 'No tiene permiso para Eliminar';
$ERR['5'] = 'No tiene permiso para Imprimir';
$ERR['6'] = 'No tiene permiso para Exportar';
$ERR['7'] = 'No tiene permiso para Clonar';
$ERR['8'] = 'No tiene permiso para Modificar el consecutivo';
$ERR['10'] = 'No tiene permiso para Administrar el documento';
$ERR['16'] = 'No tiene permiso para Cerrar el documento';
$ERR['17'] = 'No tiene permiso para Abrir el documento';
$ERR['18'] = 'No tiene permiso para Anular el documento';
$ERR['1101'] = 'No tiene permiso para Contabilizar';
$ERR['correo_enuso'] = 'La direcci&oacute;n de correo para notificaciones ya se encuentra en uso por otro usuario, si usted considera que esto es un error por favor comun&iacute;quese con soporte.campus@unad.edu.co (Por favor no olvide incluir su n&uacute;mero de documento, nombres, n&uacute;mero de tel&eacute;fono e informaci&oacute;n complementaria del porque considera que esto es un error.)';
$ERR['correo_formato'] = 'Formato de correo no reconocido';
$ERR['correo_invalido'] = 'No existe una direcci&oacute;n de correo electr&oacute;nico v&aacute;lida.';
$ERR['correo_noenvio'] = 'No fue posible comunicarse con servidor de correo, por favor utilice otro servidor de correo (ejemplo gmail.com, hotmail.com, etc.)';
$ERR['err_inactivo'] = 'No se permite usar el documento ';
$ERR['err_leydeolvido'] = 'Se aplica DERECHO AL OLVIDO para el documento ';
$ERR['existe'] = 'El c&oacute;digo ya existe.';
...
$ETI['label_ruta_nav'] = 'Ruta de navegaci&oacute;n';
$ETI['label_abrir_menu'] = 'Abrir men&uacute; principal';

// Unad librerias

$ETI['msg_fecha_incorrecta'] = 'Fecha incorrecta';
$ETI['msg_sin_fecha'] = 'Sin fecha';
$ETI['msg_formato_fecha_no_reconocido'] = 'No se reconoce el formato de fecha solicitado.';
$ETI['msg_fecha_tamano_incorrecto'] = 'La fecha no tiene el tama&ntilde;o esperado.';
$ETI['msg_fecha_separador'] = 'La fecha no usa el separador ';
$ETI['msg_correo_incorrecto'] = 'Direcci&oacute;n de correo incorrecta.';

$ETI['msg_dias_mes_html'] = ' d&iacute;as del mes de ';
$ETI['msg_dias_mes'] = 'A los ';
$ETI['msg_dias_mes_b'] = ' días del mes de ';

$ETI['msg_bajo'] = 'Bajo';
$ETI['msg_medio'] = 'Medio';
$ETI['msg_alto'] = 'Alto';
$ETI['msg_max'] = 'M&aacute;x';
...
$ETI['label_busca_lista'] = 'B&uacute;squeda y lista de ';
$ETI['label_busca_en'] = 'Buscar en ';
$ETI['msg_ingresa_busca'] = 'Ingrese una b&uacute;squeda';
$ETI['msg_sin_resultados'] = 'No se encontraron resultados';

$ETI['msg_ocultar_todo'] = 'Ocultar todo';
$ETI['msg_mostrar_todo'] = 'Mostrar todo';

$ETI['msg_codigo_descarga_a'] = 'El sistema le solicitar&aacute; el siguiente c&oacute;digo de descarga: <b>';
$ETI['msg_codigo_descarga_b'] = '</b>';
$ETI['msg_descarga_hasta'] = 'Esta descarga se encuentra disponible hasta el ';
$ETI['msg_descarga_luego_a'] = ', luego de esta fecha el sistema le solicitar&aacute; el siguiente c&oacute;digo de descarga: <b>';
$ETI['msg_descarga_luego_b'] = '</b>';
$ETI['msg_enlace_vence'] = ', Este enlace de descarga vence el ';

$ETI['msg_ayudas_manuales'] = 'Ayudas y Manuales';
$ETI['label_ayudas_manuales'] = 'Ayudas y manuales';
$ETI['label_enviar_correo'] = 'Enviar correo';
$ETI['msg_para_soporte'] = 'Para soporte:';
$ETI['msg_para_capacitacion'] = 'Para capacitaciones:';
$ETI['msg_procesos_modulo'] = 'Procesos que encontrar&aacute; en este m&oacute;dulo:';
$ETI['msg_detalle_manual'] = 'Para mayores detalles, por favor consulte el siguiente ';
$ETI['msg_manual'] = 'manual';
$ETI['label_manual_proceso'] = 'Manual asociado al proceso';
$ETI['msg_importante'] = 'Importante';
