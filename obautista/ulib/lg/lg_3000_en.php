...
--- Model Version 2.25.3 sábado, 18 de julio de 2020
...
$ETI['bt_mini_guardar_3000']='Save Historial de solicitudes';
$ETI['bt_mini_limpiar_3000']='Clear Historial de solicitudes';
$ETI['bt_mini_eliminar_3000']='Delete Historial de solicitudes';
$ETI['si']='Yes';
$ETI['no']='No';
$ETI['lnk_cargar']='Edit';
...
$ERR['saiu00idtercero']='Is necessary the data '.$ETI['saiu00idtercero'];
$ERR['saiu00idmodulo']='Is necessary the data '.$ETI['saiu00idmodulo'];
$ERR['saiu00fecha']='Is necessary the data '.$ETI['saiu00fecha'];
$ERR['saiu00idtipo']='Is necessary the data '.$ETI['saiu00idtipo'];
$ERR['saiu00idtema']='Is necessary the data '.$ETI['saiu00idtema'];
$ERR['saiu00estado']='Is necessary the data '.$ETI['saiu00estado'];
$ERR['saiu00detalle']='Is necessary the data '.$ETI['saiu00detalle'];
...
$AYU['msg_bloqueomatricula_2']='Estos cursos tienen componente pr&actico;tico, debe esperar a que estos cursos concluyan para poder proceder a solicitar el cambio de centro.';
