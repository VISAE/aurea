...
--- Model Version 2.25.10c lunes, 3 de mayo de 2021
...
$ETI['saiu47idgrupotrabajo'] = 'Grupotrabajo';
...
$ERR['saiu47agno']='Is necessary the data '.$ETI['saiu47agno'];
$ERR['saiu47mes']='Is necessary the data '.$ETI['saiu47mes'];
$ERR['saiu47tiporadicado']='Is necessary the data '.$ETI['saiu47tiporadicado'];
$ERR['saiu47tipotramite']='Is necessary the data '.$ETI['saiu47tipotramite'];
$ERR['saiu47consec']='Is necessary the data '.$ETI['saiu47consec'];
$ERR['saiu47id']='Is necessary the data '.$ETI['saiu47id'];
$ERR['saiu47origenagno']='Is necessary the data '.$ETI['saiu47origenagno'];
$ERR['saiu47origenmes']='Is necessary the data '.$ETI['saiu47origenmes'];
$ERR['saiu47origenid']='Is necessary the data '.$ETI['saiu47origenid'];
$ERR['saiu47dia']='Is necessary the data '.$ETI['saiu47dia'];
$ERR['saiu47hora']='Is necessary the data '.$ETI['saiu47hora'];
$ERR['saiu47minuto']='Is necessary the data '.$ETI['saiu47minuto'];
$ERR['saiu47idsolicitante']='Is necessary the data '.$ETI['saiu47idsolicitante'];
$ERR['saiu47idperiodo']='Is necessary the data '.$ETI['saiu47idperiodo'];
$ERR['saiu47idescuela']='Is necessary the data '.$ETI['saiu47idescuela'];
$ERR['saiu47idprograma']='Is necessary the data '.$ETI['saiu47idprograma'];
$ERR['saiu47idzona']='Is necessary the data '.$ETI['saiu47idzona'];
$ERR['saiu47idcentro']='Is necessary the data '.$ETI['saiu47idcentro'];
$ERR['saiu47estado']='Is necessary the data '.$ETI['saiu47estado'];
$ERR['saiu47t1idmotivo']='Is necessary the data '.$ETI['saiu47t1idmotivo'];
$ERR['saiu47t1vrsolicitado']='Is necessary the data '.$ETI['saiu47t1vrsolicitado'];
$ERR['saiu47t1vraprobado']='Is necessary the data '.$ETI['saiu47t1vraprobado'];
$ERR['saiu47t1vrsaldoafavor']='Is necessary the data '.$ETI['saiu47t1vrsaldoafavor'];
$ERR['saiu47t1vrdevolucion']='Is necessary the data '.$ETI['saiu47t1vrdevolucion'];
$ERR['saiu47idbenefdevol']='Is necessary the data '.$ETI['saiu47idbenefdevol'];
$ERR['saiu47idaprueba']='Is necessary the data '.$ETI['saiu47idaprueba'];
$ERR['saiu47fecha']='Is necessary the data '.$ETI['saiu47fecha'];
$ERR['saiu47hora']='Is necessary the data '.$ETI['saiu47hora'];
$ERR['saiu47minuto']='Is necessary the data '.$ETI['saiu47minuto'];
$ERR['saiu47detalle']='Is necessary the data '.$ETI['saiu47detalle'];
...
$ETI['msg_confirma41'] = 'Se va a enviar la solicitud a <b>Numeraci&oacute; SGENERAL</b>, <br>Esta seguro de continuar?';
