...
*/
	...
	*/
	$sTitulos='Perfil, Tercero, Vigente, Fechavence';
	$sSQL='SELECT T1.unad05nombre, TB.unad07idtercero, TB.unad07vigente, TB.unad07fechavence, TB.unad07idperfil 
...
'.html_lpp('lppf107', $lineastabla, 'paginarf107()').'
	...
	while($filadet=$objDB->sf($tabladetalle)){
		...
		if ($filadet['unad07vigente']=='S'){$et_unad07vigente=$sPrefijo.$ETI['si'].$sSufijo;}
		$et_unad07fechavence='';
		if ($filadet['unad07fechavence']!='00/00/0000'){$et_unad07fechavence=$sPrefijo.$filadet['unad07fechavence'].$sSufijo;}
		$res=$res.'<tr'.$sClass.'>
