...
if (!$bPeticionXAJAX) {
	if (noticias_pendientes($objDB)) {
		$objDB->CerrarConexion();
		header('Location:noticia.php?ret=saiucorreo.php');
		die();
	}
}
$bOtroUsuario=false;
...
// if ($_REQUEST['paso']!=0){
?>
<form id="frmimpp" name="frmimpp" method="post" action="p3020.php" target="_blank" style="display:none;">
...
<?php
echo $objForma->htmlExpande(3020, $_REQUEST['boculta3020'], $ETI['bt_mostrar'], $ETI['bt_ocultar']);
$sEstiloDiv = '';
...
<div id="div_p3020"<?php echo $sEstiloDiv; ?>>
<?php
}
...
<input id="saiu20idcorreootro" name="saiu20idcorreootro" type="text" value="<?php echo $_REQUEST['saiu20idcorreootro']; ?>" maxlength="50" placeholder="<?php echo $ETI['ing_campo'].$ETI['saiu20idcorreo']; ?>" class="L"/>
</label>
<div class="salto1px"></div>
...
?>
<input id="saiu20correoorigen" name="saiu20correoorigen" type="text" value="<?php echo $_REQUEST['saiu20correoorigen']; ?>" maxlength="50" placeholder="<?php echo $ETI['ing_campo'].$ETI['saiu20correoorigen']; ?>" class="L"/>
</label>
<div class="salto1px"></div>
<?php
...
<input id="titulo_3020" name="titulo_3020" type="hidden" value="<?php echo $sTituloModulo; ?>" />
<?php
if ($bBloqueTitulo) {
?>
<div class="titulos">
