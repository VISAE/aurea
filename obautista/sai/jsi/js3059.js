...
function eliminasaiu59idarchivo(){
	...
	valores[0]=window.document.frmedita.saiu47agno.value;
	valores[1]=window.document.frmedita.saiu59id.value;
	if (confirm("Esta seguro de eliminar el archivo?")){
		xajax_elimina_archivo_saiu59idarchivo(valores);
		//paginarf0000();
		}
	}
