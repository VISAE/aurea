...
if ((int)$_REQUEST['paso'] != 0) {
	...
	if ($seg_5 == 1) {
		...
		$sClaseImprime = 'btEnviarPDF'; //btUpPrint
		if ($iPiel == 0) {
...
//$html_bperfil=html_combo('bperfil', 'unad05id', 'unad05nombre', 'unad05perfiles', $sWherePerfil2, 'unad05nombre', $_REQUEST['bperfil'], $objDB, 'paginarf107()', true, '{'.$ETI['msg_todos'].'}', '');
...
<div class="Campo250">
<?php
echo html_fecha("unad07fechavence", $_REQUEST['unad07fechavence'], true, '', $iAgno, $iAgnoFin);
?>
</div>
<div class="salto1px"></div>
<label class="Label130">
...
if ($APP->idsistema == 1 && $_REQUEST['paso'] != 0) {
?>
<div class="salto1px"></div>
<div class="GrupoCampos">
<label class="TituloGrupo">
...
<script language="javascript" src="ac_107.js?v=2"></script>
