...
if (isset($_REQUEST['paginaf2357'])==0){$_REQUEST['paginaf2357']=1;}
if (isset($_REQUEST['lppf2357'])==0){$_REQUEST['lppf2357']=20;}
if (isset($_REQUEST['boculta2357'])==0){$_REQUEST['boculta2357']=0;}
...
if (isset($_REQUEST['cara57peraca'])==0){$_REQUEST['cara57peraca']='';}
...
if ($_REQUEST['paso']==23){
	...
	if ($sError==''){
		...
		list($sError, $iProcesados, $sDebugM)=f2216_MatricularPeriodo($idPeraca, $objDB, $bDebug);
...
<label class="Label30">
<input id="btexpande2357" name="btexpande2357" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(2357,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta2357']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge2357" name="btrecoge2357" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(2357,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta2357']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
</div>
<div id="div_p2357" style="display:<?php if ($_REQUEST['boculta2357']==0){echo 'block'; }else{echo 'none';} ?>;">
<?php
	}
...
-->
<label class="Label30">
<input id="btexpandeDashboard" name="btexpandeDashboard" type="button" value="Expandir" class="btMiniExpandir" onclick="expandepanel('Dashboard','block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['bocultaDashboard']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecogeDashboard" name="btrecogeDashboard" type="button" value="Recoger" class="btMiniRecoger" onclick="expandepanel('Dashboard','none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['bocultaDashboard']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
</div>
<div class="salto1px"></div>
<div id="div_pDashboard" style="display:<?php if ($_REQUEST['bocultaDashboard']==0){echo 'block'; }else{echo 'none';} ?>;">
<?php
$bconexpande=true;
if ($bGrupo1){
	$sEstilo='';
...
<div class="ir_derecha" style="width:62px;">
<label class="Label30">
<input id="btexpande101" name="btexpande101" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(101,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta101']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge101" name="btrecoge101" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(101,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta101']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="ir_derecha" style="width:62px;">
<label class="Label30">
<input id="btexpande102" name="btexpande102" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(102,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta102']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge102" name="btrecoge102" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(102,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta102']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p102" style="display:<?php if ($_REQUEST['boculta102']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<label class="Label30">
<input id="btexpande103" name="btexpande103" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(103,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta103']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge103" name="btrecoge103" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(103,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta103']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p103" style="display:<?php if ($_REQUEST['boculta103']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande104" name="btexpande104" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(104,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta104']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge104" name="btrecoge104" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(104,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta104']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p104" style="display:<?php if ($_REQUEST['boculta104']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande105" name="btexpande105" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(105,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta105']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge105" name="btrecoge105" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(105,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta105']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p105" style="display:<?php if ($_REQUEST['boculta105']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande106" name="btexpande106" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(106,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta106']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge106" name="btrecoge106" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(106,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta106']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p106" style="display:<?php if ($_REQUEST['boculta106']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande107" name="btexpande107" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(107,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta107']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge107" name="btrecoge107" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(107,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta107']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p107" style="display:<?php if ($_REQUEST['boculta107']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande108" name="btexpande108" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(108,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta108']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge108" name="btrecoge108" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(108,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta108']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p108" style="display:<?php if ($_REQUEST['boculta108']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande109" name="btexpande109" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(109,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta109']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge109" name="btrecoge109" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(109,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta109']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p109" style="display:<?php if ($_REQUEST['boculta109']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande110" name="btexpande110" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(110,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta110']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge110" name="btrecoge110" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(110,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta110']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p110" style="display:<?php if ($_REQUEST['boculta110']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
...
<div class="ir_derecha" style="width:63px;">
<label class="Label30">
<input id="btexpande111" name="btexpande111" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(111,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta111']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge111" name="btrecoge111" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(111,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta111']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
</div>
<?php
	}
...
<div class="salto1px"></div>
<div id="div_p111" style="display:<?php if ($_REQUEST['boculta111']==0){echo 'none'; }else{echo 'block';} ?>;">
<div class="GrupoCampos450">
<label class="TituloGrupo">
<?php
echo 'Grafico n';
