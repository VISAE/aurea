...
switch ($APP->idsistema){
	case 17:$iCodModuloConsulta=1791;break;
	case 23:$iCodModuloConsulta=2391;break;
	}
$audita[1]=false;
$audita[2]=true;
$audita[3]=true;
...
if (!file_exists($mensajes_105)){$mensajes_105=$APP->rutacomun.'lg/lg_105_es.php';}
...
$iPiel=$APP->piel;
$iPiel=1; //Piel 2018.
if (!seg_revisa_permiso($iCodModuloConsulta, 1, $objDB)){
...
if (!file_exists($mensajes_106)){$mensajes_106=$APP->rutacomun.'lg/lg_106_es.php';}
...
<form id="frmimpp" name="frmimpp" method="post" action="<?php echo $APP->rutacomun; ?>p105.php" target="_blank">
