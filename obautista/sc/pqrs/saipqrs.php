...
<form id="frmopcion" name="frmopcion" method="post" action="" class="login" autocomplete="off">
<div class="Cuerpo600">
<h1 class="TituloAzul1">Peticiones, Quejas, Reclamos y Solicitudes</h1>
<div class="salto5px"></div>
<label class="Label90">&nbsp;</label>
<label class="Label220">
<input id="cmdIngresa1" name="cmdIngresa1" type="button" value="Consultar PQRS" title="Consultar PQRS" onclick="realizaaccion(1);" class="BotonAzul200">
</label>
<div class="salto5px"></div>
<label class="Label90">&nbsp;</label>
<label class="Label220">
<input id="cmdIngresa1" name="cmdIngresa1" type="button" value="Radicar PQRS" title="Radicar PQRS" onclick="realizaaccion(2);" class="BotonAzul200">
</label>
<div class="salto5px"></div>
</div>
...
<?php
// Inicio Area de Consulta PQRS
?>
<div class="areaform">
<div class="areatitulo">
<?php
echo '<h3>' . 'Buscar PQRS' . '</h3>';
?>
</div>
...
$sEstiloRecoje = '';
$sEstiloDiv = '';
if ($_REQUEST['boculta3005_0'] != 0) {
	$sEstiloExpande = '';
	$sEstiloRecoje = ' style="display:none;"';
	$sEstiloDiv = ' style="display:none;"';
}
?>
<input id="boculta3005_0" name="boculta3005_0" type="hidden" value="<?php echo $_REQUEST['boculta3005_0']; ?>" />
<label class="Label30">
<input id="btexpande3005_0" name="btexpande3005_0" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel('3005_0', 'block', 0);" title="<?php echo $ETI['bt_mostrar']; ?>"<?php echo $sEstiloExpande; ?>/>
</label>
<label class="Label30">
<input id="btrecoge3005_0" name="btrecoge3005_0" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel('3005_0', 'none', 1);" title="<?php echo $ETI['bt_ocultar']; ?>" <?php echo $sEstiloRecoje; ?>/>
</label>
</div>
<div id="div_p3005_0"<?php echo $sEstiloDiv; ?>>
<?php
}
...
<input id="saiu05refdoc" name="saiu05refdoc" type="text" value="<?php echo $_REQUEST['saiu05refdoc']; ?>" maxlength="20" class="L" placeholder="<?php echo $ETI['ing_campo'] . $ETI['saiu05refdoc']; ?>" />
</label>
<label class="Label200">
<input id="cmdConsultar" name="cmdConsultar" type="button" value="Consultar" class="BotonAzul160" onclick="javascript:cargarnumref()" />
</label>
<div class="salto1px"></div>
</div>
<?php
...
<?php
if ($_REQUEST['opcion'] == 2 || $_REQUEST['saiu05id'] != '') {
?>
...
<script language="javascript">
$().ready(function() {
$("#saiu05idtiposolorigen, #saiu05idtemaorigen").chosen({
