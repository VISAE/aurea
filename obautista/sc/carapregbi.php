...
if (isset($_REQUEST['bcuerpo'])==0){$_REQUEST['bcuerpo']='';}
...
$aParametros[105]=$_REQUEST['bcuerpo'];
...
forma_cabeceraV3($xajax, $ETI['titulo_2354']);
echo $et_menu;
forma_mitad();
if (false){
?>
...
function paginarf2308(){
	...
	aParametros[105]=window.document.frmedita.bcuerpo.value;
...
<label>
<input id="bcuerpo" name="bcuerpo" type="text" value="<?php echo $_REQUEST['bcuerpo']; ?>" onchange="paginarf2308()"/>
</label>
<?php
if (false){
?>
...
<input id="titulo_2308" name="titulo_2308" type="hidden" value="<?php echo $ETI['titulo_2354']; ?>" />
<div class="titulos">
<div class="titulosD">
