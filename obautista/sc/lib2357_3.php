...
function f2357_HtmlGrafico($aParametros){
    $_SESSION['u_ultimominuto']=iminutoavance();
    $sError='';
    $bDebug=false;
    $sDebug='';
    ...
    //$sDebug=$sDebug.$sDebugTabla;
    $objDB->CerrarConexion();
    $objGraficos=new ClsGraficos('canvas_f2357grafico','map');
    $sDetalle=$objGraficos->construyeLienzo(400,500);
    //$sDetalleScript=$objGraficos->construyeScript(['Primer Gráfico','Segundo Gráfico'],[['Uno'=>150,'Dos'=>200,'Tres'=>170,'Cuatro'=>195,'Cinco'=>210],['Uno'=>50,'Tres'=>190,'Cuatro'=>135,'Cinco'=>110]],['Uno','Dos','Tres','Cuatro','Cinco'],[0,1],['blue','red'],['cyan','orange']);



    //$sDetalleScript=$objGraficos->construyeScript(['Primer Resultado'],[['Uno'=>300,'Dos'=>20,'Tres'=>40,'Cuatro'=>50,'Cinco'=>100]],['Uno','Dos','Tres','Cuatro','Cinco'],[0],['paleta1']);



    $sDetalleScript=$objGraficos->construyeScript(array('ZCAR' => 'Zona Caribe', 'ZOCC' => 'Zona Occidente', 'ZCORI' => 'Zona Centro Oriente', 'ZCBOY' => 'Zona Centro Boyacá', 'ZCBC' => 'Zona Centro Bogotá Cundinamarca', 'ZSUR' => 'Zona Sur', 'ZCSUR' => 'Zona Centro Sur', 'ZAO' => 'Zona Amazonas Orinoquia'),array('ZCAR' => '<span style=\"color:red; font-weight:bold; font-size: large;\">Zona Caribe</span>', 'ZOCC' => 'Zona Occidente', 'ZCORI' => '<table border=\"1\" align=\"center\" cellpadding=\"0\" cellspacing=\"2\" class=\"tablaapp\"><tr class=\"fondoazul\"><td><b>Uno</b></td><td><b>Dos</b></td><td><b>Tres</b></td></tr><tr class=\"fondoazul\"><td>100</td><td>200</td><td>300</td></tr><tr class=\"fondoazul\"><td>300</td><td>250</td><td>130</td></tr></table>', 'ZCBOY' => 'Zona Centro Boyacá', 'ZCBC' => 'Zona Centro Bogotá Cundinamarca', 'ZSUR' => 'Zona Sur', 'ZCSUR' => 'Zona Centro Sur', 'ZAO' => 'Zona Amazonas Orinoquia'));



    $objResponse=new xajaxResponse();
    $objResponse->assign('div_f2357grafico', 'innerHTML', $sDetalle);
    $objResponse->script($sDetalleScript);
    if ($bDebug){
        $objResponse->assign('div_debug', 'innerHTML', $sDebug);
    }
    return $objResponse;
