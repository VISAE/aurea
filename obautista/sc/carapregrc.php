...
if (isset($_REQUEST['bpregunta'])==0){$_REQUEST['bpregunta']='';}
...
forma_cabeceraV3($xajax, $ETI['titulo_2352']);
echo $et_menu;
forma_mitad();
if (false){
?>
...
function paginarf2308(){
	...
	aParametros[105]=window.document.frmedita.bpregunta.value;
...
<input id="titulo_2308" name="titulo_2308" type="hidden" value="<?php echo $ETI['titulo_2352']; ?>" />
<div class="titulos">
<div class="titulosD">
