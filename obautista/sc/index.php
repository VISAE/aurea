<?php
/*
--- © Angel Mauro Avellaneda Barreto - UNAD - 2017 - 2020 ---
...
if (!file_exists($mensajes_200)){$mensajes_200='lg/lg_2300_es.php';}
...
if (isset($_REQUEST['cara00zona'])==0){$_REQUEST['cara00zona']='';}
if (isset($_REQUEST['cara00idconsejero'])==0){$_REQUEST['cara00idconsejero']=$idTercero;}
...
<?php
//-- Bandera para los id.
//echo '<br>Su id de aplicaci&oacute;n es: '.$idTercero.'<br>';
//echo '--'.url_encode('1|1').'--';
?>
<?php
if ($seg_12==1){
