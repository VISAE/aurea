...
if ($bEntra) {
	...
	for ($l = 1; $l <= 60; $l++) {
		$sSubTitulo = '';
		if ($l == 24) {
			$sSubTitulo = 'Grupos poblacionales';
		}
		if ($l == 38) {
			$sSubTitulo = 'Discapacidades V 1.';
		}
		if ($l == 43) {
			$sSubTitulo = 'Discapacidades V 2.';
		}
	...
	$sBloque1 = '' . cadena_codificar('Tipo Caracterizacion') . $cSepara . 'TD' . $cSepara . 'Doc' . $cSepara . 'Estudiante' . $cSepara . 'Ultimo Acceso Campus' . $cSepara . 'Fecha encuesta' . $cSepara . 'Edad' . $cSepara
		...
		. 'Afrocolombiano' . $cSepara . 'Otra comunidad negra' . $cSepara . 'ROM' . $cSepara . 'Indigena' . $cSepara . 'Campesinado' . $cSepara . 'Frontera' . $cSepara . 'Victima desplazado' . $cSepara
		...
		. 'Sensorial v2' . $cSepara . 'Intelectual' . $cSepara . 'Fisica o motora' . $cSepara . 'Mental Psicosocial' . $cSepara . 'Sistemica' . $cSepara . 'Sistemica Otro' . $cSepara . 'Multiple' . $cSepara . 'Multiple Otro' . $cSepara . 'Certificado' . $cSepara . 'Tiene Trastorno en el aprendizaje' . $cSepara . 'Trastorno especifico en el aprendizaje' . $cSepara . 'Talento Excepcional' . $cSepara . 'Pruebas para definir el coeficiente intelectual' . $cSepara . 'Con condicion medica' . $cSepara . 'Cual condicion medica especifica' . $cSepara . 'Asiste a algún tipo de terapia' . $cSepara . 'Cual tipo de terapia' . '';
	...
	for ($l = 1; $l <= 35; $l++) {
		$sSubTitulo = '';
		if ($l == 14) {
			$sSubTitulo = cadena_codificar('Con cuales equipos electronicos cuenta para acceder al campus virtual de la UNAD');
		}
		if ($l == 28) {
			$sSubTitulo = cadena_codificar('La informacion que consulta la aprende mejor con');
		}
	...
	$sBloque5 = '';
	if ($bVerBienV1) {
		$sTitulo5 = $sTitulo5 . 'Bienestar V 1. - Deporte y Recreacion';
		for ($l = 1; $l <= 33; $l++) {
			$sSubTitulo = '';
			if ($l == 1) {
				$sSubTitulo = cadena_codificar('Usted practica regularmente alguna de las siguientes actividades deportivas o recreativas');
			}
			if ($l == 9) {
				$sSubTitulo = cadena_codificar('Usted practica regularmente alguna de las siguientes actividades artisticas o culturales');
			}
			if ($l == 19) {
				$sSubTitulo = cadena_codificar('Si usted practica danza por favor indique el genero');
			}
			if ($l == 23) {
				$sSubTitulo = cadena_codificar('Emprendimiento');
			}
			if ($l == 26) {
				$sSubTitulo = cadena_codificar('Estilo de vida saludable');
			}
			if ($l == 28) {
				$sSubTitulo = cadena_codificar('Proyecto de vida');
			}
			if ($l == 29) {
				$sSubTitulo = cadena_codificar('Medio ambiente');
			}
			if ($l == 30) {
				$sSubTitulo = cadena_codificar('Cual de estos habitos cotidianos realiza usted como una practica de respeto hacia Medio Ambiente');
			}
			$sTitulo5 = $sTitulo5 . $cSepara . $sSubTitulo;
		}
		$sBloque5 = $sBloque5 . $cSepara . cadena_codificar('Baloncesto' . $cSepara . 'Voleibol' . $cSepara . 'Futbol sala' .
	...
	if ($bVerBienV2) {
		$sTitulo5 = $sTitulo5 . 'Bienestar V 2. - Deporte y Recreacion';
		for ($l = 1; $l <= 93; $l++) {
			$sSubTitulo = '';
			if ($l == 1) {
				$sSubTitulo = cadena_codificar('¿Que deporte practica?');
			}
			if ($l == 11) {
				$sSubTitulo = cadena_codificar('Arte y Cultura');
			}
			if ($l == 12) {
				$sSubTitulo = cadena_codificar('Usted practica regularmente alguna de las siguientes actividades artisticas o culturales');
			}
			if ($l == 18) {
				$sSubTitulo = cadena_codificar('A que clase de eventos artisticos y culturales le gustaria asistir');
			}
			if ($l == 27) {
				$sSubTitulo = cadena_codificar('Emprendimiento');
			}
			if ($l == 29) {
				$sSubTitulo = cadena_codificar('Cual es el estado en que se encuentra su emprendimiento');
			}
			if ($l == 37) {
				$sSubTitulo = cadena_codificar('En que temas le gustaria recibir informacion con respecto al emprendimiento');
			}
			if ($l == 41) {
				$sSubTitulo = cadena_codificar('Estilo de vida saludable');
			}
			if ($l == 42) {
				$sSubTitulo = cadena_codificar('Causas mas frecuentes del estres');
			}
			if ($l == 46) {
				$sSubTitulo = cadena_codificar('Estrategias para conocer el autocuidado');
			}
			if ($l == 50) {
				$sSubTitulo = cadena_codificar('Crecimiento Personal');
			}
			if ($l == 51) {
				$sSubTitulo = cadena_codificar('Temas de interes para su crecimiento personal');
			}
			if ($l == 58) {
				$sSubTitulo = cadena_codificar('Le gustaria hacer parte de algun grupo de bienestar');
			}
			if ($l == 63) {
				$sSubTitulo = cadena_codificar('Medio ambiente');
			}
			if ($l == 64) {
				$sSubTitulo = cadena_codificar('Realiza alguna de estas acciones frente al cuidado del medio ambiente');
			}
			if ($l == 72) {
				$sSubTitulo = cadena_codificar('En su tiempo libre ha participado en alguna actividad ambiental');
			}
			if ($l == 78) {
				$sSubTitulo = cadena_codificar('Cual tema desde el enfoque ambiental le gustaria conocer o profundizar');
			}
			$sTitulo5 = $sTitulo5 . $cSepara . $sSubTitulo;
		}
	...
	if ($bVerBienV3) {
		$sTitulo5 = $sTitulo5 . 'Bienestar V 3. - Emprendimiento Solidario';
		for ($l = 1; $l <= 79; $l++) {
			$sSubTitulo = '';
			if ($l == 6) {
				$sSubTitulo = cadena_codificar('Medio Ambiente - En que tematica le gustaria participar?');
			}
			if ($l == 19) {
				$sSubTitulo = cadena_codificar('Promocion de la Salud y Prevencion de la Enfermedad');
			}
			if ($l == 24) {
				$sSubTitulo = cadena_codificar('Deporte y Recreacion');
			}
			if ($l == 30) {
				$sSubTitulo = cadena_codificar('Crecimiento Personal - Cuales temas son de su interes para fortalecer su crecimiento personal?');
			}
			if ($l == 37) {
				$sSubTitulo = cadena_codificar('Que habilidades considera que le ayudarian a desarrollar su maximo potencial?');
			}
			if ($l == 50) {
				$sSubTitulo = cadena_codificar('Que lo motiva a seguir buscando su crecimiento personal?');
			}
			if ($l == 57) {
				$sSubTitulo = cadena_codificar('Salud Mental');
			}
			if ($l == 59) {
				$sSubTitulo = cadena_codificar('Seleccione temas de interes para el cuidado de su Salud Mental');
			}
			if ($l == 75) {
				$sSubTitulo = cadena_codificar('Arte y Cultura');
			}
		...
		$sBloque5 = $sBloque5 . $cSepara . cadena_codificar('Etapa en la que se encuentra su emprendimiento' . $cSepara . 'Cual es su necesidad actual?' . $cSepara . 'Hace cuantos años su emprendimiento y/o empresa inicio operaciones en el mercado?' . $cSepara . 'Sector economico al que pertenece su idea de negocio, emprendimiento o empresa o al que se dedica desde su quehacer como intraemprendedor.' . $cSepara . 'Otro' . $cSepara . 'En cual de los siguientes temas le gustaria fortalecer principalmente su aprendizaje?'
			. $cSepara . 'Cambio climatico' . $cSepara . 'Justicia ambiental y eco-pedagogia' . $cSepara . 'Agroecologia y soberania alimentaria' . $cSepara . 'Economia circular y residuos solidos' . $cSepara . 'Educacion ambiental comunitaria' . $cSepara . 'Biodiversidad y conservacion' . $cSepara . 'Ecoturismo sostenible' . $cSepara . 'Otro' . $cSepara . 'Otra tematica' . $cSepara . 'Le gustaria ser parte de grupos ambientales de la UNAD, que promuevan el fortalecimiento de la cultura ecologica, prevencion y reduccion de impactos negativos ambientales a traves de la implementacion de experiencias ambientales?' . $cSepara . 'Que tipo de experiencias eco-pedagogicas consideras mas efectivas para tu aprendizaje ambiental?' . $cSepara . 'Como considera que el Sistema de Bienestar podria contribuir a mejorar tu bienestar ambiental como estudiante?' . $cSepara . 'Ha participado en actividades o proyectos ambientales dentro o fuera de la universidad?'
			. $cSepara . 'Que experiencias de Bienestar le motivarian para mejorar sus habitos alimenticios?' . $cSepara . 'Que tipo de estrategia considera util para prevenir el consumo de sustancias psicoactivas?' . $cSepara . 'Que apoyo le gustaria recibir en relacion con su salud visual?' . $cSepara . 'Que experiencias consideraria utiles para fortalecer su salud bucal?' . $cSepara . 'Que temas considera mas importantes para el cuidado de la salud sexual y reproductiva?'
			. $cSepara . 'Cual es su nivel de practica deportiva?' . $cSepara . 'Con que frecuencia practica usted deporte?' . $cSepara . 'Que deporte practica?' . $cSepara . 'Cual otro deporte?' . $cSepara . 'Que tipo de experiencias recreativas le gustaria que promoviera Bienestar?' . $cSepara . 'Quisiera hacer parte de un equipo representativo de la Universidad?'
			. $cSepara . 'Ciudadania, inclusion y diversidad' . $cSepara . 'Familia y relaciones afectivas' . $cSepara . 'Habilidades para fortalecer su practica academica' . $cSepara . 'Empleabilidad y desarrollo profesional' . $cSepara . 'Habilidades para la vida (comunicacion, toma de decisiones, etc.)' . $cSepara . 'Espiritualidad' . $cSepara . 'Formacion practica para la vida (cocina, belleza, costura, herramientas digitales)'
			. $cSepara . 'Liderazgo' . $cSepara . 'Trabajo en equipo' . $cSepara . 'Comunicacion asertiva' . $cSepara . 'Planeacion y gestion del tiempo' . $cSepara . 'Manejo de conflictos' . $cSepara . 'Adaptacion al cambio' . $cSepara . 'Empatia' . $cSepara . 'Gestion del ser' . $cSepara . 'Toma de decisiones' . $cSepara . 'Pensamiento creativo' . $cSepara . 'Pensamiento critico' . $cSepara . 'Otro' . $cSepara . 'Otra Habilidad'
			. $cSepara . 'Deseo de alcanzar metas personales, profesionales y laborales' . $cSepara . 'Satisfaccion personal de aprender y crecer' . $cSepara . 'Adquirir habilidades para acceder al mundo laboral' . $cSepara . 'Otra motivacion' . $cSepara . 'Cual otra motivacion' . $cSepara . 'Recibe apoyo de su familia o entorno cercano en su proceso academico?' . $cSepara . 'Que tan preparado/a se siente para enfrentar el mundo laboral?'
			. $cSepara . 'Que importancia le da al cuidado de su salud mental actualmente?' . $cSepara . 'Que le motiva a aprender estrategias de cuidado a la salud mental?'
			. $cSepara . 'Manejo del estres' . $cSepara . 'Ansiedad y tecnicas de regulacion' . $cSepara . 'Depresion y prevencion del malestar emocional' . $cSepara . 'Autoconocimiento y desarrollo personal' . $cSepara . 'Inteligencia emocional y Mindfulness' . $cSepara . 'Autoestima y autoconfianza' . $cSepara . 'Afrontamiento de crisis o duelos' . $cSepara . 'Prevencion del burnout (agotamiento emocional)' . $cSepara . 'Sexualidad y salud mental' . $cSepara . 'Uso saludable de redes sociales y tecnologia' . $cSepara . 'Inclusion y equidad' . $cSepara . 'Que espera obtener al participar en actividades de salud mental?' . $cSepara . 'Le gustaria recibir acompañamiento psicosocial en la UNAD?' . $cSepara . 'Alguna vez un profesional de la salud le ha dado un diagnostico relacionado con salud mental?' . $cSepara . 'cuál fue el diagnostico recibido?' . $cSepara . 'Cual otro diagnostico'
			. $cSepara . 'De que manera le gustaria integrar el arte y la cultura en su vida universitaria?' . $cSepara . 'en que aspecto le gustaria recibir formacion?' . $cSepara . 'Le gustaria pertenecer a un grupo representativo de la UNAD?' . $cSepara . 'Acorde a sus intereses les gustaria recibir informacion sobre:');
	}
	...
	while ($fila = $objDB->sf($tabla)) {
		if (true) {
			...
			$lin_cara44frontera = $cSepara;
			$lin_cara44med_tratamiento = $cSepara;
			$lin_cara44med_trat_cual = $cSepara;
			$lin_cara44bienv3emprenetapa = $cSepara;
			$lin_cara44bienv3emprennecesita = $cSepara;
			$lin_cara44bienv3emprenanioini = $cSepara;
			$lin_cara44bienv3emprensector = $cSepara;
			$lin_cara44bienv3emprensectorotro = $cSepara;
			$lin_cara44bienv3emprentemas = $cSepara;
			$lin_cara44bienv3ambienclima = $cSepara;
			$lin_cara44bienv3ambienjusticia = $cSepara;
			$lin_cara44bienv3ambienagroeco = $cSepara;
			$lin_cara44bienv3ambieneconomia = $cSepara;
			$lin_cara44bienv3ambieneducacion = $cSepara;
			$lin_cara44bienv3ambienbiodiverso = $cSepara;
			$lin_cara44bienv3ambienecoturismo = $cSepara;
			$lin_cara44bienv3ambienotro = $cSepara;
			$lin_cara44bienv3ambienotrodetalle = $cSepara;
			$lin_cara44bienv3ambienexper = $cSepara;
			$lin_cara44bienv3ambienaprende = $cSepara;
			$lin_cara44bienv3ambienestudiante = $cSepara;
			$lin_cara44bienv3ambienactividad = $cSepara;
			$lin_cara44bienv3pyphabitoalim = $cSepara;
			$lin_cara44bienv3pypsustanciapsico = $cSepara;
			$lin_cara44bienv3pypsaludvisual = $cSepara;
			$lin_cara44bienv3pypsaludbucal = $cSepara;
			$lin_cara44bienv3pypsaludsexual = $cSepara;
			$lin_cara44bienv3deportenivel = $cSepara;
			$lin_cara44bienv3deportefrec = $cSepara;
			$lin_cara44bienv3deportecual = $cSepara;
			$lin_cara44bienv3deportecualotro = $cSepara;
			$lin_cara44bienv3deporterecrea = $cSepara;
			$lin_cara44bienv3deporteunad = $cSepara;
			$lin_cara44bienv3creciminclusion = $cSepara;
			$lin_cara44bienv3crecimfamilia = $cSepara;
			$lin_cara44bienv3crecimhabilidad = $cSepara;
			$lin_cara44bienv3crecimempleable = $cSepara;
			$lin_cara44bienv3crecimhabilvida = $cSepara;
			$lin_cara44bienv3crecimespiritual = $cSepara;
			$lin_cara44bienv3crecimpractica = $cSepara;
			$lin_cara44bienv3crecimliderazgo = $cSepara;
			$lin_cara44bienv3crecimtrabequipo = $cSepara;
			$lin_cara44bienv3crecimasertiva = $cSepara;
			$lin_cara44bienv3crecimgesttiempo = $cSepara;
			$lin_cara44bienv3crecimconflictos = $cSepara;
			$lin_cara44bienv3crecimadapcambio = $cSepara;
			$lin_cara44bienv3crecimempatia = $cSepara;
			$lin_cara44bienv3crecimgestionser = $cSepara;
			$lin_cara44bienv3crecimtomadecide = $cSepara;
			$lin_cara44bienv3crecimpenscreativo = $cSepara;
			$lin_cara44bienv3crecimpenscritico = $cSepara;
			$lin_cara44bienv3crecimhabilotro = $cSepara;
			$lin_cara44bienv3crecimhabilotrodetalle = $cSepara;
			$lin_cara44bienv3crecimalcancemeta = $cSepara;
			$lin_cara44bienv3crecimsatifpersonal = $cSepara;
			$lin_cara44bienv3crecimaccesolaboral = $cSepara;
			$lin_cara44bienv3crecimotramotiv = $cSepara;
			$lin_cara44bienv3crecimotramotivdetalle = $cSepara;
			$lin_cara44bienv3crecimapoyo = $cSepara;
			$lin_cara44bienv3crecimlaboral = $cSepara;
			$lin_cara44bienv3mentalcuidado = $cSepara;
			$lin_cara44bienv3mentalestrategia = $cSepara;
			$lin_cara44bienv3mentalestres = $cSepara;
			$lin_cara44bienv3mentalansiedad = $cSepara;
			$lin_cara44bienv3mentaldepresion = $cSepara;
			$lin_cara44bienv3mentalautoconoc = $cSepara;
			$lin_cara44bienv3mentalmindfulness = $cSepara;
			$lin_cara44bienv3mentalautoestima = $cSepara;
			$lin_cara44bienv3mentalcrisis = $cSepara;
			$lin_cara44bienv3mentalburnout = $cSepara;
			$lin_cara44bienv3mentalsexualidad = $cSepara;
			$lin_cara44bienv3mentalusoredes = $cSepara;
			$lin_cara44bienv3mentalinclusion = $cSepara;
			$lin_cara44bienv3mentalactividad = $cSepara;
			$lin_cara44bienv3mentalacompana = $cSepara;
			$lin_cara44bienv3mentaldiagnostico = $cSepara;
			$lin_cara44bienv3mentaldiagcual = $cSepara;
			$lin_cara44bienv3mentaldiagotro = $cSepara;
			$lin_cara44bienv3arteintegrar = $cSepara;
			$lin_cara44bienv3arteformacion = $cSepara;
			$lin_cara44bienv3arteunad = $cSepara;
			$lin_cara44bienv3arteinformacion = $cSepara;
		}
		if (!$bPorTipo) {
		...
		if ($fila1 = $objDB->sf($tabla1)) {
			...
			if ($fila1['cara44frontera'] == 0) {
				$lin_cara44frontera = $cSepara . 'No';
			}
			if ($aBloque[2]) {
			...
			if ($aBloque[5] && $bVerBienV3) {
				if (isset($acara44bienv3emprenetapa[$fila1['cara44bienv3emprenetapa']]) != 0) {
					$lin_cara44bienv3emprenetapa = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3emprenetapa[$fila1['cara44bienv3emprenetapa']]));
				}
				if (isset($acara44bienv3emprennecesita[$fila1['cara44bienv3emprennecesita']]) != 0) {
					$lin_cara44bienv3emprennecesita = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3emprennecesita[$fila1['cara44bienv3emprennecesita']]));
				}
				if (isset($acara44bienv3emprenanioini[$fila1['cara44bienv3emprenanioini']]) != 0) {
					$lin_cara44bienv3emprenanioini = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3emprenanioini[$fila1['cara44bienv3emprenanioini']]));
				}
				...
				$lin_cara44bienv3ambienclima = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambienclima'] == 0) {
					$lin_cara44bienv3ambienclima = $cSepara . 'No';
				}
				$lin_cara44bienv3ambienjusticia = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambienjusticia'] == 0) {
					$lin_cara44bienv3ambienjusticia = $cSepara . 'No';
				}
				$lin_cara44bienv3ambienagroeco = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambienagroeco'] == 0) {
					$lin_cara44bienv3ambienagroeco = $cSepara . 'No';
				}
				$lin_cara44bienv3ambieneconomia = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambieneconomia'] == 0) {
					$lin_cara44bienv3ambieneconomia = $cSepara . 'No';
				}
				$lin_cara44bienv3ambieneducacion = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambieneducacion'] == 0) {
					$lin_cara44bienv3ambieneducacion = $cSepara . 'No';
				}
				$lin_cara44bienv3ambienbiodiverso = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambienbiodiverso'] == 0) {
					$lin_cara44bienv3ambienbiodiverso = $cSepara . 'No';
				}
				$lin_cara44bienv3ambienecoturismo = $cSepara . 'Si';
				if ($fila1['cara44bienv3ambienecoturismo'] == 0) {
					$lin_cara44bienv3ambienecoturismo = $cSepara . 'No';
				}
				$lin_cara44bienv3ambienotro = $cSepara . 'Si';
				...
				if (isset($acara44bienv3ambienaprende[$fila1['cara44bienv3ambienaprende']]) != 0) {
					$lin_cara44bienv3ambienaprende = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3ambienaprende[$fila1['cara44bienv3ambienaprende']]));
				}
				if (isset($acara44bienv3ambienestudiante[$fila1['cara44bienv3ambienestudiante']]) != 0) {
					$lin_cara44bienv3ambienestudiante = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3ambienestudiante[$fila1['cara44bienv3ambienestudiante']]));
				}
				if (isset($acara44bienv3ambienactividad[$fila1['cara44bienv3ambienactividad']]) != 0) {
					$lin_cara44bienv3ambienactividad = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3ambienactividad[$fila1['cara44bienv3ambienactividad']]));
				}
				if (isset($acara44bienv3pyphabitoalim[$fila1['cara44bienv3pyphabitoalim']]) != 0) {
					$lin_cara44bienv3pyphabitoalim = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3pyphabitoalim[$fila1['cara44bienv3pyphabitoalim']]));
				}
				if (isset($acara44bienv3pypsustanciapsico[$fila1['cara44bienv3pypsustanciapsico']]) != 0) {
					$lin_cara44bienv3pypsustanciapsico = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3pypsustanciapsico[$fila1['cara44bienv3pypsustanciapsico']]));
				}
				if (isset($acara44bienv3pypsaludvisual[$fila1['cara44bienv3pypsaludvisual']]) != 0) {
					$lin_cara44bienv3pypsaludvisual = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3pypsaludvisual[$fila1['cara44bienv3pypsaludvisual']]));
				}
				if (isset($acara44bienv3pypsaludbucal[$fila1['cara44bienv3pypsaludbucal']]) != 0) {
					$lin_cara44bienv3pypsaludbucal = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3pypsaludbucal[$fila1['cara44bienv3pypsaludbucal']]));
				}
				if (isset($acara44bienv3pypsaludsexual[$fila1['cara44bienv3pypsaludsexual']]) != 0) {
					$lin_cara44bienv3pypsaludsexual = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3pypsaludsexual[$fila1['cara44bienv3pypsaludsexual']]));
				}
				if (isset($acara44bienv3deportenivel[$fila1['cara44bienv3deportenivel']]) != 0) {
					$lin_cara44bienv3deportenivel = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3deportenivel[$fila1['cara44bienv3deportenivel']]));
				}
				if (isset($acara44bienv3deportefrec[$fila1['cara44bienv3deportefrec']]) != 0) {
					$lin_cara44bienv3deportefrec = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3deportefrec[$fila1['cara44bienv3deportefrec']]));
				}
				...
				$lin_cara44bienv3deporteunad = $cSepara . 'Si';
				if ($fila1['cara44bienv3deporteunad'] == 0) {
					$lin_cara44bienv3deporteunad = $cSepara . 'No';
				}
				$lin_cara44bienv3creciminclusion = $cSepara . 'Si';
				if ($fila1['cara44bienv3creciminclusion'] == 0) {
					$lin_cara44bienv3creciminclusion = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimfamilia = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimfamilia'] == 0) {
					$lin_cara44bienv3crecimfamilia = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimhabilidad = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimhabilidad'] == 0) {
					$lin_cara44bienv3crecimhabilidad = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimempleable = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimempleable'] == 0) {
					$lin_cara44bienv3crecimempleable = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimhabilvida = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimhabilvida'] == 0) {
					$lin_cara44bienv3crecimhabilvida = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimespiritual = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimespiritual'] == 0) {
					$lin_cara44bienv3crecimespiritual = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimpractica = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimpractica'] == 0) {
					$lin_cara44bienv3crecimpractica = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimliderazgo = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimliderazgo'] == 0) {
					$lin_cara44bienv3crecimliderazgo = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimtrabequipo = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimtrabequipo'] == 0) {
					$lin_cara44bienv3crecimtrabequipo = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimasertiva = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimasertiva'] == 0) {
					$lin_cara44bienv3crecimasertiva = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimgesttiempo = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimgesttiempo'] == 0) {
					$lin_cara44bienv3crecimgesttiempo = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimconflictos = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimconflictos'] == 0) {
					$lin_cara44bienv3crecimconflictos = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimadapcambio = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimadapcambio'] == 0) {
					$lin_cara44bienv3crecimadapcambio = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimempatia = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimempatia'] == 0) {
					$lin_cara44bienv3crecimempatia = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimgestionser = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimgestionser'] == 0) {
					$lin_cara44bienv3crecimgestionser = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimtomadecide = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimtomadecide'] == 0) {
					$lin_cara44bienv3crecimtomadecide = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimpenscreativo = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimpenscreativo'] == 0) {
					$lin_cara44bienv3crecimpenscreativo = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimpenscritico = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimpenscritico'] == 0) {
					$lin_cara44bienv3crecimpenscritico = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimhabilotro = $cSepara . 'Si';
				...
				$lin_cara44bienv3crecimsatifpersonal = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimsatifpersonal'] == 0) {
					$lin_cara44bienv3crecimsatifpersonal = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimaccesolaboral = $cSepara . 'Si';
				if ($fila1['cara44bienv3crecimaccesolaboral'] == 0) {
					$lin_cara44bienv3crecimaccesolaboral = $cSepara . 'No';
				}
				$lin_cara44bienv3crecimotramotiv = $cSepara . 'Si';
				...
				if (isset($acara44bienv3crecimlaboral[$fila1['cara44bienv3crecimlaboral']]) != 0) {
					$lin_cara44bienv3crecimlaboral = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3crecimlaboral[$fila1['cara44bienv3crecimlaboral']]));
				}
				if (isset($acara44bienv3mentalcuidado[$fila1['cara44bienv3mentalcuidado']]) != 0) {
					$lin_cara44bienv3mentalcuidado = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3mentalcuidado[$fila1['cara44bienv3mentalcuidado']]));
				}
				if (isset($acara44bienv3mentalestrategia[$fila1['cara44bienv3mentalestrategia']]) != 0) {
					$lin_cara44bienv3mentalestrategia = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3mentalestrategia[$fila1['cara44bienv3mentalestrategia']]));
				}
				$lin_cara44bienv3mentalestres = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalestres'] == 0) {
					$lin_cara44bienv3mentalestres = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalansiedad = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalansiedad'] == 0) {
					$lin_cara44bienv3mentalansiedad = $cSepara . 'No';
				}
				$lin_cara44bienv3mentaldepresion = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentaldepresion'] == 0) {
					$lin_cara44bienv3mentaldepresion = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalautoconoc = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalautoconoc'] == 0) {
					$lin_cara44bienv3mentalautoconoc = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalmindfulness = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalmindfulness'] == 0) {
					$lin_cara44bienv3mentalmindfulness = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalautoestima = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalautoestima'] == 0) {
					$lin_cara44bienv3mentalautoestima = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalcrisis = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalcrisis'] == 0) {
					$lin_cara44bienv3mentalcrisis = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalburnout = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalburnout'] == 0) {
					$lin_cara44bienv3mentalburnout = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalsexualidad = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalsexualidad'] == 0) {
					$lin_cara44bienv3mentalsexualidad = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalusoredes = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalusoredes'] == 0) {
					$lin_cara44bienv3mentalusoredes = $cSepara . 'No';
				}
				$lin_cara44bienv3mentalinclusion = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalinclusion'] == 0) {
					$lin_cara44bienv3mentalinclusion = $cSepara . 'No';
				}
				if (isset($acara44bienv3mentalactividad[$fila1['cara44bienv3mentalactividad']]) != 0) {
					$lin_cara44bienv3mentalactividad = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3mentalactividad[$fila1['cara44bienv3mentalactividad']]));
				}
				$lin_cara44bienv3mentalacompana = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentalacompana'] == 0) {
					$lin_cara44bienv3mentalacompana = $cSepara . 'No';
				}
				$lin_cara44bienv3mentaldiagnostico = $cSepara . 'Si';
				if ($fila1['cara44bienv3mentaldiagnostico'] == 0) {
					$lin_cara44bienv3mentaldiagnostico = $cSepara . 'No';
				}
				...
				if (isset($acara44bienv3arteformacion[$fila1['cara44bienv3arteformacion']]) != 0) {
					$lin_cara44bienv3arteformacion = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3arteformacion[$fila1['cara44bienv3arteformacion']]));
				}
				$lin_cara44bienv3arteunad = $cSepara . 'Si';
				if ($fila1['cara44bienv3arteunad'] == 0) {
					$lin_cara44bienv3arteunad = $cSepara . 'No';
				}
				if (isset($acara44bienv3arteinformacion[$fila1['cara44bienv3arteinformacion']]) != 0) {
					$lin_cara44bienv3arteinformacion = $cSepara . cadena_codificar(html_entity_decode($acara44bienv3arteinformacion[$fila1['cara44bienv3arteinformacion']]));
				}
			}
		}
		if (true) {
			...
			if ($fila['cara01zonares'] == 'R') {
				$lin_cara01zonares = $cSepara . 'Rural';
			}
			...
			if (isset($acara01discsensorial[$fila['cara01discsensorial']]) != 0) {
				$lin_cara01discsensorial = $cSepara . $acara01discsensorial[$fila['cara01discsensorial']];
			}
			$lin_cara01discfisica = $cSepara . $fila['cara01discfisica'];
			if (isset($acara01discfisica[$fila['cara01discfisica']]) != 0) {
				$lin_cara01discfisica = $cSepara . $acara01discfisica[$fila['cara01discfisica']];
			}
			$lin_cara01disccognitiva = $cSepara . $fila['cara01disccognitiva'];
			if (isset($acara01disccognitiva[$fila['cara01disccognitiva']]) != 0) {
				$lin_cara01disccognitiva = $cSepara . $acara01disccognitiva[$fila['cara01disccognitiva']];
			}
		...
		*/
		...
		if ($aBloque[7]) {
			if ($fila['cara01fichadigital'] != -1) {
				$lin_cara01fichadigital = $cSepara . f2301_NombrePuntaje('digital', $fila['cara01niveldigital']);
			}
			if ($fila['cara01fichalectura'] != -1) {
				$lin_cara01fichalectura = $cSepara . f2301_NombrePuntaje('lectura', $fila['cara01nivellectura']);
			}
			if ($fila['cara01ficharazona'] != -1) {
				$lin_cara01ficharazona = $cSepara . f2301_NombrePuntaje('razona', $fila['cara01nivelrazona']);
			}
			if ($fila['cara01fichaingles'] != -1) {
				$lin_cara01fichaingles = $cSepara . f2301_NombrePuntaje('ingles', $fila['cara01nivelingles']);
			}
			if ($fila['cara01fichafisica'] != -1) {
				$lin_cara01fichafisica = $cSepara . f2301_NombrePuntaje('fisica', $fila['cara01nivelfisica']);
			}
			if ($fila['cara01fichaquimica'] != -1) {
				$lin_cara01fichaquimica = $cSepara . f2301_NombrePuntaje('quimica', $fila['cara01nivelquimica']);
			}
		...
		$sBienV3 = '';
		if ($bVerBienV1) {
			$sBienV1 = '' . $lin_cara01bien_baloncesto . $lin_cara01bien_voleibol . $lin_cara01bien_futbolsala .
		...
		if ($bVerBienV2) {
			$sBienV2 = '' . $lin_cara44bienv2altoren . $lin_cara44bienv2atletismo . $lin_cara44bienv2baloncesto . $lin_cara44bienv2futbol . $lin_cara44bienv2gimnasia . $lin_cara44bienv2natacion . $lin_cara44bienv2voleibol . $lin_cara44bienv2tenis . $lin_cara44bienv2paralimpico . $lin_cara44bienv2otrodeporte . $lin_cara44bienv2otrodeportedetalle .
		...
		if ($bVerBienV3) {
			$sBienV3 = '' . $lin_cara44bienv3emprenetapa . $lin_cara44bienv3emprennecesita . $lin_cara44bienv3emprenanioini . $lin_cara44bienv3emprensector . $lin_cara44bienv3emprensectorotro . $lin_cara44bienv3emprentemas .
				$lin_cara44bienv3ambienclima . $lin_cara44bienv3ambienjusticia . $lin_cara44bienv3ambienagroeco . $lin_cara44bienv3ambieneconomia . $lin_cara44bienv3ambieneducacion . $lin_cara44bienv3ambienbiodiverso . $lin_cara44bienv3ambienecoturismo . $lin_cara44bienv3ambienotro . $lin_cara44bienv3ambienotrodetalle . $lin_cara44bienv3ambienexper . $lin_cara44bienv3ambienaprende . $lin_cara44bienv3ambienestudiante . $lin_cara44bienv3ambienactividad .
				$lin_cara44bienv3pyphabitoalim . $lin_cara44bienv3pypsustanciapsico . $lin_cara44bienv3pypsaludvisual . $lin_cara44bienv3pypsaludbucal . $lin_cara44bienv3pypsaludsexual .
				$lin_cara44bienv3deportenivel . $lin_cara44bienv3deportefrec . $lin_cara44bienv3deportecual . $lin_cara44bienv3deportecualotro . $lin_cara44bienv3deporterecrea . $lin_cara44bienv3deporteunad .
				$lin_cara44bienv3creciminclusion . $lin_cara44bienv3crecimfamilia . $lin_cara44bienv3crecimhabilidad . $lin_cara44bienv3crecimempleable . $lin_cara44bienv3crecimhabilvida . $lin_cara44bienv3crecimespiritual . $lin_cara44bienv3crecimpractica . $lin_cara44bienv3crecimliderazgo . $lin_cara44bienv3crecimtrabequipo . $lin_cara44bienv3crecimasertiva . $lin_cara44bienv3crecimgesttiempo . $lin_cara44bienv3crecimconflictos . $lin_cara44bienv3crecimadapcambio . $lin_cara44bienv3crecimempatia . $lin_cara44bienv3crecimgestionser . $lin_cara44bienv3crecimtomadecide . $lin_cara44bienv3crecimpenscreativo . $lin_cara44bienv3crecimpenscritico . $lin_cara44bienv3crecimhabilotro . $lin_cara44bienv3crecimhabilotrodetalle . $lin_cara44bienv3crecimalcancemeta . $lin_cara44bienv3crecimsatifpersonal . $lin_cara44bienv3crecimaccesolaboral . $lin_cara44bienv3crecimotramotiv . $lin_cara44bienv3crecimotramotivdetalle . $lin_cara44bienv3crecimapoyo . $lin_cara44bienv3crecimlaboral .
				$lin_cara44bienv3mentalcuidado . $lin_cara44bienv3mentalestrategia . $lin_cara44bienv3mentalestres . $lin_cara44bienv3mentalansiedad . $lin_cara44bienv3mentaldepresion . $lin_cara44bienv3mentalautoconoc . $lin_cara44bienv3mentalmindfulness . $lin_cara44bienv3mentalautoestima . $lin_cara44bienv3mentalcrisis . $lin_cara44bienv3mentalburnout . $lin_cara44bienv3mentalsexualidad . $lin_cara44bienv3mentalusoredes . $lin_cara44bienv3mentalinclusion . $lin_cara44bienv3mentalactividad . $lin_cara44bienv3mentalacompana . $lin_cara44bienv3mentaldiagnostico . $lin_cara44bienv3mentaldiagcual . $lin_cara44bienv3mentaldiagotro .
				$lin_cara44bienv3arteintegrar . $lin_cara44bienv3arteformacion . $lin_cara44bienv3arteunad . $lin_cara44bienv3arteinformacion;
		}
