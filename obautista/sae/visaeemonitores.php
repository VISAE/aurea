...
if (isset($_REQUEST['paginaf2931'])==0){$_REQUEST['paginaf2931']=1;}
if (isset($_REQUEST['lppf2931'])==0){$_REQUEST['lppf2931']=20;}
if (isset($_REQUEST['boculta2931'])==0){$_REQUEST['boculta2931']=0;}
if (isset($_REQUEST['paginaf2932'])==0){$_REQUEST['paginaf2932']=1;}
if (isset($_REQUEST['lppf2932'])==0){$_REQUEST['lppf2932']=20;}
if (isset($_REQUEST['boculta2932'])==0){$_REQUEST['boculta2932']=0;}
if (isset($_REQUEST['paginaf2933'])==0){$_REQUEST['paginaf2933']=1;}
if (isset($_REQUEST['lppf2933'])==0){$_REQUEST['lppf2933']=20;}
if (isset($_REQUEST['boculta2933'])==0){$_REQUEST['boculta2933']=0;}
// -- Inicializar variables de datos.
if (isset($_REQUEST['plab31consec'])==0){$_REQUEST['plab31consec']='';}
if (isset($_REQUEST['plab31consec_nuevo'])==0){$_REQUEST['plab31consec_nuevo']='';}
if (isset($_REQUEST['plab31id'])==0){$_REQUEST['plab31id']='';}
if (isset($_REQUEST['plab31vigente'])==0){$_REQUEST['plab31vigente']='S';}
if (isset($_REQUEST['plab31titulo'])==0){$_REQUEST['plab31titulo']='';}
if (isset($_REQUEST['plab31idconvocatoria'])==0){$_REQUEST['plab31idconvocatoria']='';}
if (isset($_REQUEST['plab31fechainicio'])==0){$_REQUEST['plab31fechainicio']='';}//{fecha_hoy();}
if (isset($_REQUEST['plab31fechafinal'])==0){$_REQUEST['plab31fechafinal']='';}//{fecha_hoy();}
if ((int)$_REQUEST['paso']>0){
	//Participantes
	if (isset($_REQUEST['plab32idtercero'])==0){$_REQUEST['plab32idtercero']=0;}//{$_SESSION['unad_id_tercero'];}
	if (isset($_REQUEST['plab32idtercero_td'])==0){$_REQUEST['plab32idtercero_td']=$APP->tipo_doc;}
	if (isset($_REQUEST['plab32idtercero_doc'])==0){$_REQUEST['plab32idtercero_doc']='';}
	if (isset($_REQUEST['plab32id'])==0){$_REQUEST['plab32id']='';}
	if (isset($_REQUEST['plab32estado'])==0){$_REQUEST['plab32estado']='';}
	if (isset($_REQUEST['plab32fechaingreso'])==0){$_REQUEST['plab32fechaingreso']='';}//{fecha_hoy();}
	if (isset($_REQUEST['plab32fechafin'])==0){$_REQUEST['plab32fechafin']='';}//{fecha_hoy();}
	//Acceso a cursos
	if (isset($_REQUEST['plab33idmonitor'])==0){$_REQUEST['plab33idmonitor']=0;}//{$_SESSION['unad_id_tercero'];}
	if (isset($_REQUEST['plab33idmonitor_td'])==0){$_REQUEST['plab33idmonitor_td']=$APP->tipo_doc;}
	if (isset($_REQUEST['plab33idmonitor_doc'])==0){$_REQUEST['plab33idmonitor_doc']='';}
	if (isset($_REQUEST['plab33idperiodo'])==0){$_REQUEST['plab33idperiodo']='';}
	if (isset($_REQUEST['plab33idcurso'])==0){$_REQUEST['plab33idcurso']='';}
	if (isset($_REQUEST['plab33id'])==0){$_REQUEST['plab33id']='';}
	if (isset($_REQUEST['plab33activo'])==0){$_REQUEST['plab33activo']='S';}
	}
...
if ((int)$_REQUEST['paso']>0){
	//Participantes
	if (isset($_REQUEST['bnombre2932'])==0){$_REQUEST['bnombre2932']='';}
	//if (isset($_REQUEST['blistar2932'])==0){$_REQUEST['blistar2932']='';}
	//Accesos
	if (isset($_REQUEST['bnombre2933'])==0){$_REQUEST['bnombre2933']='';}
	}
...
if (($_REQUEST['paso']==10)||($_REQUEST['paso']==12)){
	$bMueveScroll=true;
	list($_REQUEST, $sError, $iTipoError, $sDebugGuardar)=f2931_db_GuardarV2($_REQUEST, $objDB, $bDebug, $idTercero);
...
if ($_REQUEST['paso']==93){
	...
	if ($_REQUEST['plab31consec_nuevo']==''){$sError=$ERR['plab31consec'];}
	if ($sError==''){
...
if ($_REQUEST['paso']==-1){
	...
	$_REQUEST['plab31fechainicio']='';//fecha_hoy();
	$_REQUEST['plab31fechafinal']='';//fecha_hoy();
	$_REQUEST['paso']=0;
	}
if ($bLimpiaHijos){
...
$html_plab31vigente=$objCombos->html('', $objDB);
$objCombos->nuevo('plab31idconvocatoria', $_REQUEST['plab31idconvocatoria'], true, '{'.$ETI['msg_ninguna'].'}', 0);
//$objCombos->addArreglo($aplab31idconvocatoria, $iplab31idconvocatoria);
$html_plab31idconvocatoria=$objCombos->html('', $objDB);
if ((int)$_REQUEST['paso']==0){
	}else{
...
forma_cabeceraV3($xajax, $ETI['titulo_2931']);
echo $et_menu;
forma_mitad();
if (false){
?>
...
function ter_muestra(idcampo, illave){
	...
	if (params[1]!=''){
		...
		if (illave==1){revisaf2932();}
		if (illave==2){revisaf2933();}
		}
	}
...
if ($_REQUEST['paso']!=0){
?>
<script language="javascript" src="jsi/js2932.js"></script>
<script language="javascript" src="jsi/js2933.js"></script>
<form id="frmimpp" name="frmimpp" method="post" action="p2931.php" target="_blank">
...
<input id="boculta2931" name="boculta2931" type="hidden" value="<?php echo $_REQUEST['boculta2931']; ?>" />
<label class="Label30">
<input id="btexpande2931" name="btexpande2931" type="button" value="Mostrar" class="btMiniExpandir" onclick="expandepanel(2931,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta2931']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge2931" name="btrecoge2931" type="button" value="Ocultar" class="btMiniRecoger" onclick="expandepanel(2931,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta2931']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
</div>
<div id="div_p2931" style="display:<?php if ($_REQUEST['boculta2931']==0){echo 'block'; }else{echo 'none';} ?>;">
<?php
	}
...
<input id="boculta2932" name="boculta2932" type="hidden" value="<?php echo $_REQUEST['boculta2932']; ?>" />
<?php
if ($_REQUEST['paso']==2){
	//if ($bCondicion){
?>
...
?>
<label class="Label30">
<input id="btexcel2932" name="btexcel2932" type="button" value="Exportar" class="btMiniExcel" onclick="imprime2932();" title="Exportar"/>
</label>
<?php
	}
?>
<label class="Label30">
<input id="btexpande2932" name="btexpande2932" type="button" value="Expandir" class="btMiniExpandir" onclick="expandepanel(2932,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta2932']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge2932" name="btrecoge2932" type="button" value="Recoger" class="btMiniRecoger" onclick="expandepanel(2932,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta2932']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
</div>
<div class="salto1px"></div>
...
<input id="boculta2933" name="boculta2933" type="hidden" value="<?php echo $_REQUEST['boculta2933']; ?>" />
<?php
if ($_REQUEST['paso']==2){
	//if ($bCondicion){
?>
...
?>
<label class="Label30">
<input id="btexcel2933" name="btexcel2933" type="button" value="Exportar" class="btMiniExcel" onclick="imprime2933();" title="Exportar"/>
</label>
<?php
	}
?>
<label class="Label30">
<input id="btexpande2933" name="btexpande2933" type="button" value="Expandir" class="btMiniExpandir" onclick="expandepanel(2933,'block',0);" title="<?php echo $ETI['bt_mostrar']; ?>" style="display:<?php if ($_REQUEST['boculta2933']==0){echo 'none'; }else{echo 'block';} ?>;"/>
</label>
<label class="Label30">
<input id="btrecoge2933" name="btrecoge2933" type="button" value="Recoger" class="btMiniRecoger" onclick="expandepanel(2933,'none',1);" title="<?php echo $ETI['bt_ocultar']; ?>" style="display:<?php if ($_REQUEST['boculta2933']==0){echo 'block'; }else{echo 'none';} ?>;"/>
</label>
</div>
<div class="salto1px"></div>
...
<div class="ir_derecha"<?php echo $sAnchoExpandeContrae; ?>>
<label class="Label30">
<input id="btexcel2931" name="btexcel2931" type="button" value="Formato de carga" class="btMiniExcel" onclick="verformato();" title="Formato de carga"/>
</label>
</div>
<label class="TituloGrupo">
<?php
...
<input id="titulo_2931" name="titulo_2931" type="hidden" value="<?php echo $ETI['titulo_2931']; ?>" />
<div class="titulos">
<div class="titulosD">
...
<script language="javascript">
$().ready(function(){
$("#plab33idperiodo").chosen();
$("#plab33idcurso").chosen();
});
</script>
<?php
	}
