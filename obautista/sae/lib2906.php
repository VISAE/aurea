...
<div class="salto1px"></div>
	...
	*/
	...
	$sSQL='SELECT TB.plab06consecutivo, TB.plab06id, TB.plab06nombre 
...
function f2906_db_GuardarV2($DATA, $objDB, $bDebug=false){
	...
	*/
	...
	if ($sError==''){
		$bpasa=false;
		if ($DATA['paso']==10){
			$sCampos2906='plab06consecutivo, plab06id, plab06nombre';
			$sValores2906=''.$DATA['plab06consecutivo'].', '.$DATA['plab06id'].', "'.$DATA['plab06nombre'].'"';
			if ($APP->utf8==1){
