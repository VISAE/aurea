...
<div class="salto1px"></div>
	...
	*/
	...
	$sSQL='SELECT TB.plab04consecutivo, TB.plab04id, TB.plab04nombre 
...
function f2904_db_GuardarV2($DATA, $objDB, $bDebug=false){
	...
	*/
	...
	if ($sError==''){
		$bpasa=false;
		if ($DATA['paso']==10){
			$sCampos2904='plab04consecutivo, plab04id, plab04nombre';
			$sValores2904=''.$DATA['plab04consecutivo'].', '.$DATA['plab04id'].', "'.$DATA['plab04nombre'].'"';
			if ($APP->utf8==1){
