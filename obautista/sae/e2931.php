...
if ($bEntra){
	...
	if ($sError==''){
		...
		//Titulo 
		$objHoja->setCellValueByColumnAndRow(0, 10, 'E-monitores');
		...
		*/
		...
		$sCondi='';
		$sSQL='SELECT * 
FROM plab31emonitoresciclo 
WHERE plab31consec='.$DATA['plab31consec'].'';
		...
		while ($fila=$objDB->sf($tabla)){
			$objHoja->setCellValueByColumnAndRow(0, $iFila, $fila['plab31consec']);
			$objHoja->setCellValueByColumnAndRow(1, $iFila, $fila['plab31id']);
			$objHoja->setCellValueByColumnAndRow(2, $iFila, $fila['plab31vigente']);
			$objHoja->setCellValueByColumnAndRow(3, $iFila, $fila['plab31titulo']);
			$objHoja->setCellValueByColumnAndRow(4, $iFila, $fila['plab31idconvocatoria']);
			$objHoja->setCellValueByColumnAndRow(5, $iFila, $fila['plab31fechainicio']);
			$objHoja->setCellValueByColumnAndRow(6, $iFila, $fila['plab31fechafinal']);
			$iFila++;
			}
