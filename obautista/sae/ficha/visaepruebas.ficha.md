# Ficha técnica · Componente APP· Módulo 2938 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 2938 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib2938.php' ('f2938_*').
- Internacionalización: 'presupuesto/lg/lg_2938_{es|en|pt}.php'.
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f2938_db_GuardarV2b'.
   - Eliminar llama a 'f2938_db_Eliminar'.
   - Tabla inferior se carga con 'f2938_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f2938_db_GuardarV2b'/'f2938_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'visa38idtipo' | Tipo convocatoria. | Numerico. | Requerido en creación. |
| 'visa38consec' | Consecutivo. | Numérico gestionado por el sistema; modificable con permiso 8. | Entero positivo. |
| 'visa38id' | Ref. | Numérico opcional; si es 0 toma 'visa38consec'. | Entero positivo. |
| 'visa38nombre' | Nombre prueba (<=50 chars). | Texto. | Requerido, sanitizado con 'cadena_Validar'. |
| 'visa38tipoprueba' | Tipoprueba. | Numerico. | Requerido en creación. |
| 'visa38puntajemaximo' | Puntaje. | Numerico. | Requerido en creación. |
| 'visa38puntajeaproba' | Puntajeaproba. | Numerico. | Requerido en creación. |
| 'visa38activo' | Activo. | Numerico. | Requerido en creación. |
| 'visa38idnav' | Idnav. | Numerico. | Requerido en creación. |
| 'visa38idmoodle' | Idmoodle. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta2938', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f2938_TablaDetalleV2' | 'lib2938.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f2938detalle'. |
| 'f2938_db_GuardarV2b' | 'lib2938.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f2938_db_Eliminar' | 'lib2938.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f2938_ExisteDato' | 'lib2938.php' | Verifica existencia por consecutivo y redirige formulario. |
...
2. Modificar 'visa38consec' sin permiso 8 (debe fallar).
