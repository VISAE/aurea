# Ficha técnica · Componente APP· Módulo 2957 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 2957 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib2957.php' ('f2957_*').
- Internacionalización: 'presupuesto/lg/lg_2957_{es|en|pt}.php'.
...
- Versión del módulo: v1.0.0 (baseline 16/9/2026, Juan David Avellaneda Molina).
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f2957_db_GuardarV2b'.
   - Eliminar llama a 'f2957_db_Eliminar'.
   - Tabla inferior se carga con 'f2957_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f2957_db_GuardarV2b'/'f2957_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'visa57idpersemanal' | Idpersemanal. | Numerico. | Requerido en creación. |
| 'visa57idsistema' | Sistema. | Numerico. | Requerido en creación. |
| 'visa57consec' | Consecutivo. | Numérico gestionado por el sistema; modificable con permiso 8. | Entero positivo. |
| 'visa57id' | Ref. | Numérico opcional; si es 0 toma 'visa57consec'. | Entero positivo. |
| 'visa57titulo' | Titulo (<=200 chars). | Texto. | Requerido, sanitizado con 'cadena_Validar'. |
| 'visa57descripcion' | Descripcion. | Numerico. | Requerido en creación. |
| 'visa57tipoactividad' | Tipoactividad. | Numerico. | Requerido en creación. |
| 'visa57estado' | Estado. | Numerico. | Requerido en creación. |
| 'visa57prioridad' | Prioridad. | Numerico. | Requerido en creación. |
| 'visa57fechaprogini' | Fecha inicio. | Numerico. | Requerido en creación. |
| 'visa57fechaprogfin' | Fecha fin. | Numerico. | Requerido en creación. |
| 'visa57fechaejecini' | Fechaejecini. | Numerico. | Requerido en creación. |
| 'visa57fechaejecfin' | Fechaejecfin. | Numerico. | Requerido en creación. |
| 'visa57porcavance' | Avance. | Numerico. | Requerido en creación. |
| 'visa57fechacrea' | Fechacrea. | Numerico. | Requerido en creación. |
| 'visa57fechaactualiza' | Fechaactualiza. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta2957', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f2957_TablaDetalleV2' | 'lib2957.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f2957detalle'. |
| 'f2957_db_GuardarV2b' | 'lib2957.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f2957_db_Eliminar' | 'lib2957.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f2957_ExisteDato' | 'lib2957.php' | Verifica existencia por consecutivo y redirige formulario. |
...
| --- | --- | --- | --- |
| 1.0.0 | 21-09-2023 | Creación del módulo, portado de Arquitectura Áurea v2.30.1b. | Juan David Avellaneda Molina. |

## 10. Pruebas sugeridas
1. Intentar guardar sin campos obligatorios .
2. Modificar 'visa57consec' sin permiso 8 (debe fallar).
