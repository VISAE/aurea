# Ficha técnica · Componente APP· Módulo 2956 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 2956 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib2956.php' ('f2956_*').
- Internacionalización: 'presupuesto/lg/lg_2956_{es|en|pt}.php'.
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f2956_db_GuardarV2b'.
   - Eliminar llama a 'f2956_db_Eliminar'.
   - Tabla inferior se carga con 'f2956_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f2956_db_GuardarV2b'/'f2956_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'visa56consec' | Consecutivo. | Numérico gestionado por el sistema; modificable con permiso 8. | Entero positivo. |
| 'visa56id' | Ref. | Numérico opcional; si es 0 toma 'visa56consec'. | Entero positivo. |
| 'visa56fechaini' | Fecha inicio. | Numerico. | Requerido en creación. |
| 'visa56fechafin' | Fecha fin. | Numerico. | Requerido en creación. |
| 'visa56estado' | Estado. | Numerico. | Requerido en creación. |
| 'visa56fechacrea' | Fechacrea. | Numerico. | Requerido en creación. |
| 'visa56fechacierre' | Fecha cierre. | Numerico. | Requerido en creación. |
| 'visa56observacion' | Observacion. | Numerico. | Requerido en creación. |
| 'visa56activo' | Activo. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta2956', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f2956_TablaDetalleV2' | 'lib2956.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f2956detalle'. |
| 'f2956_db_GuardarV2b' | 'lib2956.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f2956_db_Eliminar' | 'lib2956.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f2956_ExisteDato' | 'lib2956.php' | Verifica existencia por consecutivo y redirige formulario. |
...
2. Modificar 'visa56consec' sin permiso 8 (debe fallar).
