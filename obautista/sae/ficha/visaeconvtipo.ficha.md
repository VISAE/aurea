# Ficha técnica · Componente APP· Módulo 2934 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 2934 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib2934.php' ('f2934_*').
- Internacionalización: 'presupuesto/lg/lg_2934_{es|en|pt}.php'.
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f2934_db_GuardarV2b'.
   - Eliminar llama a 'f2934_db_Eliminar'.
   - Tabla inferior se carga con 'f2934_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f2934_db_GuardarV2b'/'f2934_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'visa34consec' | Consecutivo. | Numérico gestionado por el sistema; modificable con permiso 8. | Entero positivo. |
| 'visa34id' | Ref. | Numérico opcional; si es 0 toma 'visa34consec'. | Entero positivo. |
| 'visa34nombre' | Nombre (<=100 chars). | Texto. | Requerido, sanitizado con 'cadena_Validar'. |
| 'visa34rolestudiante' | Rol estudiante. | Numerico. | Requerido en creación. |
| 'visa34roladministrativo' | Rol administrativo. | Numerico. | Requerido en creación. |
| 'visa34rolacademico' | Rol académico. | Numerico. | Requerido en creación. |
| 'visa34rolaspirante' | Rol aspirante. | Numerico. | Requerido en creación. |
| 'visa34rolegresado' | Rol egresado. | Numerico. | Requerido en creación. |
| 'visa34rolexterno' | Rol externo. | Numerico. | Requerido en creación. |
| 'visa34grupotipologia' | Grupo tipología. | Numerico. | Requerido en creación. |
| 'visa34activo' | Activo. | Numerico. | Requerido en creación. |
| 'visa34aplicazona' | Aplicazona. | Numerico. | Requerido en creación. |
| 'visa34aplicacentro' | Aplicacentro. | Numerico. | Requerido en creación. |
| 'visa34aplicaescuela' | Aplicaescuela. | Numerico. | Requerido en creación. |
| 'visa34aplicaprograma' | Aplicaprograma. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta2934', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f2934_TablaDetalleV2' | 'lib2934.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f2934detalle'. |
| 'f2934_db_GuardarV2b' | 'lib2934.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f2934_db_Eliminar' | 'lib2934.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f2934_ExisteDato' | 'lib2934.php' | Verifica existencia por consecutivo y redirige formulario. |
...
2. Modificar 'visa34consec' sin permiso 8 (debe fallar).
