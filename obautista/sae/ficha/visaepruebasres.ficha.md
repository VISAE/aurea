# Ficha técnica · Componente APP· Módulo 2945 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 2945 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib2945.php' ('f2945_*').
- Internacionalización: 'presupuesto/lg/lg_2945_{es|en|pt}.php'.
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f2945_db_GuardarV2b'.
   - Eliminar llama a 'f2945_db_Eliminar'.
   - Tabla inferior se carga con 'f2945_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f2945_db_GuardarV2b'/'f2945_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'visa45idinscripcion' | Idinscripcion. | Numerico. | Requerido en creación. |
| 'visa45idprueba' | Prueba. | Numerico. | Requerido en creación. |
| 'visa45id' | Ref. | Numérico opcional. | Entero positivo. |
| 'visa45puntaje' | Puntaje. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta2945', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f2945_TablaDetalleV2' | 'lib2945.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f2945detalle'. |
| 'f2945_db_GuardarV2b' | 'lib2945.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f2945_db_Eliminar' | 'lib2945.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f2945_ExisteDato' | 'lib2945.php' | Verifica existencia por consecutivo y redirige formulario. |
