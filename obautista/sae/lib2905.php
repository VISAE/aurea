...
<div class="salto1px"></div>
	...
	*/
	...
	$sSQL='SELECT TB.plab05consecutivo, TB.plab05id, TB.plab05nombre 
...
function f2905_db_GuardarV2($DATA, $objDB, $bDebug=false){
	...
	*/
	...
	if ($sError==''){
		$bpasa=false;
		if ($DATA['paso']==10){
			$sCampos2905='plab05consecutivo, plab05id, plab05nombre';
			$sValores2905=''.$DATA['plab05consecutivo'].', '.$DATA['plab05id'].', "'.$DATA['plab05nombre'].'"';
			if ($APP->utf8==1){
