...
<div class="salto1px"></div>
	...
	*/
	$sTitulos='Consecutivo, Id, Nombre, Programa';
	$sSQL='SELECT TB.plab02consecutivo, TB.plab02id, TB.plab02nombre, T4.core09nombre, TB.plab02programa 
...
function f2902_db_GuardarV2($DATA, $objDB, $bDebug=false){
	...
	*/
	...
	if ($sError==''){
		$bpasa=false;
		if ($DATA['paso']==10){
			$sCampos2902='plab02consecutivo, plab02id, plab02nombre, plab02programa';
			$sValores2902=''.$DATA['plab02consecutivo'].', '.$DATA['plab02id'].', "'.$DATA['plab02nombre'].'", '.$DATA['plab02programa'].'';
			if ($APP->utf8==1){
