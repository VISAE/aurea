...
if ($bEntra) {
	...
	//-- Area para saltar comparaciones con los archivos tipo e
		...
		$iFila=12;
		$objHoja->setCellValueByColumnAndRow(0, $iFila, 'Solicitud de cambio de documento');
	...
	//-- Fin del area no comparada
		$sSQL = 'SELECT * 
		FROM unae24historialcambdoc 
		WHERE unae24idtercero="' . $DATA['unae24idtercero'] . '" AND unae24consec=' . $DATA['unae24consec'] . '';
		...
		while ($fila = $objDB->sf($tabla)) {
			$objHoja->setCellValueByColumnAndRow(0, $iFila, $fila['unae24idtercero']);
			$objHoja->setCellValueByColumnAndRow(1, $iFila, $fila['unae24consec']);
			$objHoja->setCellValueByColumnAndRow(2, $iFila, $fila['unae24id']);
			$objHoja->setCellValueByColumnAndRow(3, $iFila, $fila['unae24tipodocorigen']);
			$objHoja->setCellValueByColumnAndRow(4, $iFila, $fila['unae24docorigen']);
			$objHoja->setCellValueByColumnAndRow(5, $iFila, $fila['unae24or_nombre1']);
			$objHoja->setCellValueByColumnAndRow(6, $iFila, $fila['unae24or_nombre2']);
			$objHoja->setCellValueByColumnAndRow(7, $iFila, $fila['unae24or_apellido1']);
			$objHoja->setCellValueByColumnAndRow(8, $iFila, $fila['unae24or_apellido2']);
			$objHoja->setCellValueByColumnAndRow(9, $iFila, $fila['unae24or_sexo']);
			$objHoja->setCellValueByColumnAndRow(10, $iFila, $fila['unae24or_fechanac']);
			$objHoja->setCellValueByColumnAndRow(11, $iFila, $fila['unae24or_fechadoc']);
			$objHoja->setCellValueByColumnAndRow(12, $iFila, $fila['unae24tipodocdestino']);
			$objHoja->setCellValueByColumnAndRow(13, $iFila, $fila['unae24docdestino']);
			$objHoja->setCellValueByColumnAndRow(14, $iFila, $fila['unae24des_nombre1']);
			$objHoja->setCellValueByColumnAndRow(15, $iFila, $fila['unae24des_nombre2']);
			$objHoja->setCellValueByColumnAndRow(16, $iFila, $fila['unae24des_apellido1']);
			$objHoja->setCellValueByColumnAndRow(17, $iFila, $fila['unae24des_apellido2']);
			$objHoja->setCellValueByColumnAndRow(18, $iFila, $fila['unae24des_sexo']);
			$objHoja->setCellValueByColumnAndRow(19, $iFila, $fila['unae24des_fechanac']);
			$objHoja->setCellValueByColumnAndRow(20, $iFila, $fila['unae24des_fechadoc']);
			$objHoja->setCellValueByColumnAndRow(21, $iFila, $fila['unae24idsolicita']);
			$objHoja->setCellValueByColumnAndRow(22, $iFila, $fila['unae24fechasol']);
			$objHoja->setCellValueByColumnAndRow(23, $iFila, $fila['unae24horasol']);
			$objHoja->setCellValueByColumnAndRow(24, $iFila, $fila['unae24minsol']);
			$objHoja->setCellValueByColumnAndRow(25, $iFila, $fila['unae24idorigen']);
			$objHoja->setCellValueByColumnAndRow(26, $iFila, $fila['unae24idarchivo']);
			$objHoja->setCellValueByColumnAndRow(27, $iFila, $fila['unae24estado']);
			$objHoja->setCellValueByColumnAndRow(28, $iFila, $fila['unae24detalle']);
			$objHoja->setCellValueByColumnAndRow(29, $iFila, $fila['unae24idaprueba']);
			$objHoja->setCellValueByColumnAndRow(30, $iFila, $fila['unae24fechaapr']);
			$objHoja->setCellValueByColumnAndRow(31, $iFila, $fila['unae24horaaprueba']);
			$objHoja->setCellValueByColumnAndRow(32, $iFila, $fila['unae24minaprueba']);
			$objHoja->setCellValueByColumnAndRow(33, $iFila, $fila['unae24tiempod']);
			$objHoja->setCellValueByColumnAndRow(34, $iFila, $fila['unae24tiempoh']);
			$iFila++;
		}
