...
if (isset($_REQUEST['even02publicado'])==0){$_REQUEST['even02publicado']='N';}
...
$objCombos->nuevo('even02peraca', $_REQUEST['even02peraca'], false, '{'.$ETI['msg_seleccione'].'}');
...
if ((int)$_REQUEST['paso']==0){
	...
	$sSQLadd='(0,7,8,9)';
	if($_REQUEST['even02estado']>=9){$sSQLadd='(7,8,9)';}
	$sSQL='SELECT even13id AS id, even13nombre AS nombre FROM even13estadoasistencia WHERE even13id IN '.$sSQLadd.' ORDER BY even13nombre';
...
$bCancelado=false;
$bEnDesarrollo=false;
$bEnInscripciones=false;
$bInscripcionesCerradas=false;
$bTerminado=false;
$comboPublicado=false;
if($_REQUEST['paso']==2) {
    switch ($_REQUEST['even02estado']) {
        case 0:
            $lbeven02estado = $ETI['msg_enproyecto'];
            $bEnInscripciones = true;
            $bCancelado = true;
            break;
        case 5:
            $lbeven02estado = $ETI['msg_eninscripciones'];
            $bInscripcionesCerradas = true;
            $bCancelado = true;
            $comboPublicado = true;
            break;
        case 6:
            $lbeven02estado = $ETI['msg_inscripcionescerradas'];
            $bEnDesarrollo = true;
            $bCancelado = true;
            $comboPublicado = true;
            break;
        case 7:
            $lbeven02estado = $ETI['msg_endesarrollo'];
            $bTerminado = true;
            $comboPublicado = true;
            break;
        case 9:
            $lbeven02estado = $ETI['msg_cancelado'];
            break;
        case 10:
            $lbeven02estado = $ETI['msg_terminado'];
            break;
	    }
	$lbeven02estado = html_oculto('even02estado', $_REQUEST['even02estado'], $lbeven02estado);
	}
...
function cambiaEstadoEvento(estado){
	window.document.frmedita.even02estado.value=estado;
	enviaguardar();
	}
// -->
</script>
...
?>
<label class="Label200">
<input id="cmdendesarrollo" name="cmdendesarrollo" type="button" class="BotonAzul Label200" value="<?php echo $ETI['msg_endesarrollo']; ?>" onclick="cambiaEstadoEvento(7)" title="<?php echo $ETI['msg_endesarrollo']; ?>"/>
</label>
<?php
	}
?>
...
?>
<label class="Label200">
<input id="cmdeninscripciones" name="cmdeninscripciones" type="button" class="BotonAzul Label200" value="<?php echo $ETI['msg_eninscripciones']; ?>" onclick="cambiaEstadoEvento(5)" title="<?php echo $ETI['msg_eninscripciones']; ?>"/>
</label>
<?php
	}
?>
<?php
if ($bInscripcionesCerradas){
?>
<label class="Label200">
<input id="cmdinscripcionescerradas" name="cmdinscripcionescerradas" type="button" class="BotonAzul Label200" value="<?php echo $ETI['msg_inscripcionescerradas']; ?>" onclick="cambiaEstadoEvento(6)" title="<?php echo $ETI['msg_inscripcionescerradas']; ?>"/>
</label>
<?php
	}
?>
...
?>
<label class="Label130">
<input id="cmdterminado" name="cmdterminado" type="button" class="BotonAzul" value="<?php echo $ETI['msg_terminado']; ?>" onclick="cambiaEstadoEvento(10)" title="<?php echo $ETI['msg_terminado']; ?>"/>
</label>
<?php
	}
?>
...
?>
<label class="Label130">
<input id="cmdcancelado" name="cmdcancelado" type="button" class="BotonAzul" value="<?php echo $ETI['msg_cancelado']; ?>" onclick="cambiaEstadoEvento(9)" title="<?php echo $ETI['msg_cancelado']; ?>"/>
</label>
<?php
	}
?>
...
?>
<input id="even02publicado" name="even02publicado" type="hidden" value="<?php echo $_REQUEST['even02publicado']; ?>"/>
<?php
}
?>
<label class="L">
