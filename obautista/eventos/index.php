...
--- Modelo Versión 1.2.7 Jueves, 2 de octubre de 2014 
...
$iSector=1;
$modnombre='Sistema de Gesti&oacute;n de eventos';
$modsigla='Panel';
...
<div class="titulosI">
<h1>Panel Sistema de Gesti&oacute;n de Eventos V 1.0 - UNAD</h1>
</div>
</div>
<div class="areaform">
...
<?php
//-- Bandera para los id.
echo '<br>Su id de aplicaci&oacute;n es: '.$_SESSION['unad_id_tercero'].'<br>';
?>
