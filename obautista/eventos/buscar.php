...
require_once '../ulib/unad_todas.php';
if ($_SESSION['unad_id_tercero']<1){
	header("Location:nopermiso.php");
	die();
	}
require_once '../ulib/libs/clsdbadmin.php';
require_once '../ulib/unad_librerias.php';
$campos=0;
$tabla='';
$swherebase='';
$sgroupbase='';
...
if ($campos!=0){
	...
	if ($_REQUEST['paso']==51){
		...
		$objPHPExcel->getProperties()->setCreator("Mauro Avellaneda - http://www.inandina.edu.co/");
		$objPHPExcel->getProperties()->setLastModifiedBy("Mauro Avellaneda - http://www.inandina.edu.co/");
		...
		$objPHPExcel->getProperties()->setDescription("Resultados de la busqueda en http://www.inandina.edu.co/");
		$ifila=6;
		for ($i=1;$i<=$campos;$i++){
