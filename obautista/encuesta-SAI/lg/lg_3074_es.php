...
$ERR['saiu74codmodulo'] = 'Necesita el dato ' . $ETI['saiu74codmodulo'];
$ERR['saiu74idreg'] = 'Necesita el dato ' . $ETI['saiu74idreg'];
$ERR['saiu74id'] = 'Necesita el dato ' . $ETI['saiu74id'];
$ERR['saiu74agno'] = 'Necesita el dato ' . $ETI['saiu74agno'];
$ERR['saiu74acepta'] = 'Necesita el dato ' . $ETI['saiu74acepta'];
$ERR['saiu74fecharespuesta'] = $ETI['saiu74fecharespuesta'] . ' incorrecta';
$ERR['saiu74preg1'] = 'Necesita el dato ' . $ETI['saiu74preg1'];
$ERR['saiu74preg2'] = 'Necesita el dato ' . $ETI['saiu74preg2'];
$ERR['saiu74preg3'] = 'Necesita el dato ' . $ETI['saiu74preg3'];
$ERR['saiu74preg4'] = 'Necesita el dato ' . $ETI['saiu74preg4'];
$ERR['saiu74preg5'] = 'Necesita el dato ' . $ETI['saiu74preg5'];
$ERR['saiu74preg6'] = 'Necesita el dato ' . $ETI['saiu74preg6'];
$ERR['saiu74comentario'] = 'Necesita el dato ' . $ETI['saiu74comentario'];
