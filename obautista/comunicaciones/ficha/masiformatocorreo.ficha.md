# Ficha técnica · Componente APP· Módulo 1210 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 1210 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib1210.php' ('f1210_*').
- Internacionalización: 'presupuesto/lg/lg_1210_{es|en|pt}.php'.
...
- Versión del módulo: v1.0.0 (baseline 27/3/2026, Angel Mauro Avellaneda Barreto).
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f1210_db_GuardarV2b'.
   - Eliminar llama a 'f1210_db_Eliminar'.
   - Tabla inferior se carga con 'f1210_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f1210_db_GuardarV2b'/'f1210_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'masi10consec' | Consecutivo. | Numérico gestionado por el sistema; modificable con permiso 8. | Entero positivo. |
| 'masi10id' | Ref. | Numérico opcional; si es 0 toma 'masi10consec'. | Entero positivo. |
| 'masi1oactivo' | Activo. | Numerico. | Requerido en creación. |
| 'masi10titulo' | Titulo (<=100 chars). | Texto. | Requerido, sanitizado con 'cadena_Validar'. |
| 'masi10encabezado' | Encabezado. | Numerico. | Requerido en creación. |
| 'masi10divcuerpo' | Divcuerpo. | Numerico. | Requerido en creación. |
| 'masi10divcodigocorreo' | Divcodigocorreo. | Numerico. | Requerido en creación. |
| 'masi10divcodigoconfirma' | Divcodigoconfirma. | Numerico. | Requerido en creación. |
| 'masi10divcodigorecupera' | Divcodigorecupera. | Numerico. | Requerido en creación. |
| 'masi10divfirma' | Divfirma. | Numerico. | Requerido en creación. |
| 'masi10piedepagina' | Piedepagina. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta1210', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f1210_TablaDetalleV2' | 'lib1210.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f1210detalle'. |
| 'f1210_db_GuardarV2b' | 'lib1210.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f1210_db_Eliminar' | 'lib1210.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f1210_ExisteDato' | 'lib1210.php' | Verifica existencia por consecutivo y redirige formulario. |
...
2. Modificar 'masi10consec' sin permiso 8 (debe fallar).
