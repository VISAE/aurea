# Ficha técnica · Componente APP· Módulo 1200 "Familias presupuestales"

## 1. Identificación
- Componente: NomAPP (APP 000).
- Módulo: 1200 – 'ppto60familiappto'.
- Ruta de entrada: '_comp_/pptofamilia.php'.
- Lógica de negocio reutilizable: 'presupuesto/lib1200.php' ('f1200_*').
- Internacionalización: 'presupuesto/lg/lg_1200_{es|en|pt}.php'.
...
5. Acciones de usuario:
   - Guardar/actualizar llaman a 'f1200_db_GuardarV2b'.
   - Eliminar llama a 'f1200_db_Eliminar'.
   - Tabla inferior se carga con 'f1200_TablaDetalleV2' vía XAJAX.
...
| 'seg_2/3/4' | Crear, editar, borrar (validado dentro de 'f1200_db_GuardarV2b'/'f1200_db_Eliminar'). |

## 5. Formulario y campos
| Campo | Descripción | Fuente/Regla | Validaciones |
| --- | --- | --- | --- |
| 'masi00id' | Ref. | Numerico. | Requerido en creación. |
| 'masi00idformato' | Formato de correos. | Numerico. | Requerido en creación. |
| 'masi00formaenvios' | Forma de envio. | Numerico. | Requerido en creación. |
| 'deb_tipodoc', 'deb_doc' | Acceso delegado. | Sólo visibles con 'seg_1707'. | Validan existencia en 'unad11terceros'. |
| Ocultos ('paso', 'iscroll', 'boculta1200', 'debug', etc.) | Control de estado. | – | – |

## 6. Servicios XAJAX destacados
| Función | Archivo | Descripción |
| --- | --- | --- |
| 'f1200_TablaDetalleV2' | 'lib1200.php' | Construye tabla HTML filtrada/paginada, retorna 'div_f1200detalle'. |
| 'f1200_db_GuardarV2b' | 'lib1200.php' | Alta/edición con validaciones de permisos, largos y auditoría ('seg_auditar'). |
| 'f1200_db_Eliminar' | 'lib1200.php' | Elimina tras revisar bloqueos ('unad70bloqueoelimina'). |
| 'f1200_ExisteDato' | 'lib1200.php' | Verifica existencia por consecutivo y redirige formulario. |
