	...
	if ($objDB->nf($tabla) == 0) {
		...
		if ($objDB->nf($tabla) > 0) {
			...
			if ($iDiasSeparacion > 364) {
				if ($bDebug) {
					$sDebug = $sDebug . fecha_microtiempo() . ' Se inicia encuenta de antiguo, dias desde la caracterizacion: ' . $iDiasSeparacion . '<br>';
				}
				$bInsertarEncuesta = true;
