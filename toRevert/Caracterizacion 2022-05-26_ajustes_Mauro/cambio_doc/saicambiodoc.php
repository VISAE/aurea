...
if (isset($_REQUEST['unae24fechasol']) == 0) {
	$_REQUEST['unae24fechasol'] = '';}//{fecha_hoy();
}
...
if (isset($_REQUEST['unae24idaprueba']) == 0) {
	$_REQUEST['unae24idaprueba'] = $_SESSION['unad_id_tercero'];
}
...
if (isset($_REQUEST['unae24fechaapr']) == 0) {
	$_REQUEST['unae24fechaapr'] = '';}//{fecha_hoy();
}
...
if ($_REQUEST['paso'] == -1) {
	...
	$_REQUEST['unae24estado'] = 0;
	$_REQUEST['unae24detalle'] = '';
	$_REQUEST['unae24idaprueba'] = $idTercero;
	$_REQUEST['unae24idaprueba_td'] = $APP->tipo_doc;
	$_REQUEST['unae24idaprueba_doc'] = '';
	$_REQUEST['unae24fechaapr'] = ''; //fecha_hoy();
	$_REQUEST['unae24horaaprueba'] = fecha_hora();
...
<label>
<?php
echo $html_unae24tipodocdestino;
?>
</label>
<label class="Label130">
<?php
...
<?php
echo html_oculto('unae24fechasol', $_REQUEST['unae24fechasol'], fecha_desdenumero($_REQUEST['unae24fechasol'])); //formato_FechaLargaDesdeNumero
?>
</div>
</label>
<label class="Label130">
