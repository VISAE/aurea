...
if ((int)$_REQUEST['paso'] == 0) {
	...
	$saiu70idzona_nombre = '&nbsp;';
	if ($_REQUEST['saiu70idzona'] != '') {
		if ((int)$_REQUEST['saiu70idzona'] == 0) {
			$saiu70idzona_nombre = '{' . $ETI['msg_todas'] . '}';
		} else {
	...
	if ($_REQUEST['saiu70idcentro'] != '') {
		if ((int)$_REQUEST['saiu70idcentro'] == 0) {
			$saiu70idcentro_nombre = '{' . $ETI['msg_todos'] . '}';
		} else {
	...
	if ($_REQUEST['saiu70idescuela'] != '') {
		if ((int)$_REQUEST['saiu70idescuela'] == 0) {
			$saiu70idescuela_nombre = '{' . $ETI['msg_todas'] . '}';
		} else {
	...
	if ($_REQUEST['saiu70idprograma'] != '') {
		if ((int)$_REQUEST['saiu70idprograma'] == 0) {
			$saiu70idprograma_nombre = '{' . $ETI['msg_todos'] . '}';
		} else {
