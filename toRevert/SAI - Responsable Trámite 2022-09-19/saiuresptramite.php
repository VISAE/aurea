...
if ((int)$_REQUEST['paso'] == 0) {
	...
	if ((int)$_REQUEST['saiu70idzona'] != 0) {
		list($saiu70idzona_nombre, $sErrorDet) = tabla_campoxid('unad23zona', 'unad23nombre', 'unad23id', $_REQUEST['saiu70idzona'], '{' . $ETI['msg_sindato'] . '}', $objDB);
	}
	...
	if ((int)$_REQUEST['saiu70idcentro'] != 0) {
		list($saiu70idcentro_nombre, $sErrorDet) = tabla_campoxid('unad24sede', 'unad24nombre', 'unad24id', $_REQUEST['saiu70idcentro'], '{' . $ETI['msg_sindato'] . '}', $objDB);
	}
	...
	if ((int)$_REQUEST['saiu70idescuela'] != 0) {
		list($saiu70idescuela_nombre, $sErrorDet) = tabla_campoxid('core12escuela', 'core12nombre', 'core12id', $_REQUEST['saiu70idescuela'], '{' . $ETI['msg_sindato'] . '}', $objDB);
	}
	...
	if ((int)$_REQUEST['saiu70idprograma'] != 0) {
		list($saiu70idprograma_nombre, $sErrorDet) = tabla_campoxid('core09programa', 'core09nombre', 'core09id', $_REQUEST['saiu70idprograma'], '{' . $ETI['msg_sindato'] . '}', $objDB);
	}
...
//$html_blistar = $objCombos->comboSistema(3070, 1, $objDB, 'paginarf3070()');
*/
if (false) {
...
<label>
<input id="bnombre" name="bnombre" type="text" value="<?php echo $_REQUEST['bnombre']; ?>" onchange="paginarf3070()" autocomplete="off" />
</label>
<label class="Label90">
<?php
